...
/*
	...
	int crd = 190;
	gEngfuncs.pTriAPI->TexCoord2f( 0.0f, 1.0f ); gEngfuncs.pTriAPI->Vertex3f( Suncoordx + crd, Suncoordy + crd, 0 ); //top left
	gEngfuncs.pTriAPI->TexCoord2f( 0.0f, 0.0f ); gEngfuncs.pTriAPI->Vertex3f( Suncoordx + crd, Suncoordy - crd, 0 ); //bottom left
	gEngfuncs.pTriAPI->TexCoord2f( 1.0f, 0.0f ); gEngfuncs.pTriAPI->Vertex3f( Suncoordx - crd, Suncoordy - crd, 0 ); //bottom right
	gEngfuncs.pTriAPI->TexCoord2f( 1.0f, 1.0f ); gEngfuncs.pTriAPI->Vertex3f( Suncoordx - crd, Suncoordy + crd, 0 ); //top right
