...
#define MAX_VISIBLE_PACKET	4096//1024	// 10 bits
#define MAX_MODELS		4096	// engine limit
...
#define MAX_CACHED_STATES	4096	// 32 kb cache (this needs only for bmodels)
#define MAX_LIGHTCACHE	4096 //2048	// unique models with instanced vertex lighting
