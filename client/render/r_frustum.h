/*
r_frustum.h - frustum test implementation class
...
public:
	...
	void InitOrthogonal( const matrix4x4 &view, float xLeft, float xRight, float yTop, float yBottom, float flZNear, float flZFar );
	...
	bool Intersect( CFrustum *otherFrustum );
