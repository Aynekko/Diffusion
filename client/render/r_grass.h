...
#define GRASS_ANIM_DIST		512.0f // diffusion - NOTENOTE I have enabled animation all the time in the shader, so this value is not accounted, but it's being used in the code
