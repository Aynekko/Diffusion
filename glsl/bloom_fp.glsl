...
{	
	...
	tex += textureBicubic( u_ScreenMap, var_TexCoord, 2.0, texSize );
	...
	texSize = floor( texSize * 0.5 );
	tex += textureBicubic( u_ScreenMap, var_TexCoord, 5.0, texSize * 2.0 );
	texSize = floor( texSize * 0.5 );
	tex += textureBicubic( u_ScreenMap, var_TexCoord, 6.0, texSize * 2.0 );
	tex *= 0.2;		
