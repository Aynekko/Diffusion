...
uniform vec2		u_GenericCondition;

#define rendersize u_GenericCondition.xy
...
{
    return texture2D( u_ColorMap, p ).rgb;
}
...
void main( void )
{
    ...
    FsrEasuCon( con0, con1, con2, con3, rendersize, rendersize, u_ScreenSizeInv );
