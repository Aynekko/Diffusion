...
#define MAX_WAYPOINT_CONNECTIONS 5
...
#define BOT_YAW_SPEED 15  // degrees per 10th of second turning speed
#define BOT_YAW_SPEED_ENEMYTRACK 4

#define BOT_SKIN_LEN 16
#define BOT_NAME_LEN 31

#define BOT_KNIFE_DISTANCE 75
