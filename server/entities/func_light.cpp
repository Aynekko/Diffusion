...
void CFuncLight::Spawn(void)
{
	...
	if (HasSpawnFlags(SF_LIGHT_START_ON))
...
//=========================================================================
// diffusion - the entity was marked for deletion. turn the light off
//=========================================================================
void CFuncLight::ClearEffects(void)
{
	LIGHT_STYLE( m_iStyle, "a" );
}