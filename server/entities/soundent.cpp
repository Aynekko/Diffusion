...
// sound info.
// diffusion - added entindex for filtering the sounds.
// example: if the index of "sound" matches monster's index, monster won't react to this sound (his own shooting sounds)
//=========================================================
void CSoundEnt :: InsertSound ( int iType, const Vector &vecOrigin, int iVolume, float flDuration, int entindex )
{
	int	iThisSound;
	...
	pSoundEnt->m_SoundPool[ iThisSound ].m_entindex = entindex;
}
