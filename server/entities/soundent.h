...
#define MAX_WORLD_SOUNDS	128	// maximum number of sounds handled by the world at one time. // diffusion - was 64
...
public:
	...
	int m_entindex; // diffusion - filter this sound. entity with matched index won't hear it
...
public:
	...
	static void	InsertSound ( int iType, const Vector &vecOrigin, int iVolume, float flDuration, int entindex = 0 );
