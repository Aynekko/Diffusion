...
void CFuncTrain::ClearEffects( void )
{
	Stop();
}
...
void CFuncTrackTrain::ClearEffects(void)
{
	Stop();
}
...
void CFuncTrackTrain :: Use( CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value )
{
	...
	{
		// g-cont. Don't control, if tracktrain on trackchange
		if( m_ppath == NULL ) 
			return;
...
void CFuncTrackTrain :: Spawn( void )
{
	...
	// NOTE: cull the tracktrain by PHS because it may be out of PVS
