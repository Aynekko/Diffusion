...
void ClientUserInfoChanged( edict_t *pEntity, char *infobuffer )
{
	...
	if ( pEntity->v.netname && STRING(pEntity->v.netname)[0] != 0 && !FIStrEq( STRING(pEntity->v.netname), g_engfuncs.pfnInfoKeyValue( infobuffer, "name" )) )
	{
		char sName[256];
...
//	PRECACHE_SOUND("debris/wood3.wav");
	...
	PRECACHE_SOUND("buttons/spark1.wav");		// hit computer texture
