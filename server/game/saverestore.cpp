...
#define ENTVARS_COUNT	SIZEOFARRAY( gEntvarsDescription )
...
//	DEFINE_ENTITY_FIELD( flags2, FIELD_FLOAT ),
	...
	DEFINE_ENTITY_FIELD( iuser4, FIELD_INTEGER ),		// diffusion - fadedistance!!! do not use it anywhere else! Or you can use negative numbers, they are fine
