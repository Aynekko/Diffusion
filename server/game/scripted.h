...
#include "game/scriptevent.h"
#endif

#define SF_SCRIPT_WAITTILLSEEN		BIT(0)
#define SF_SCRIPT_EXITAGITATED		BIT(1)
#define SF_SCRIPT_REPEATABLE		BIT(2)
#define SF_SCRIPT_LEAVECORPSE		BIT(3)
//#define SF_SCRIPT_INTERPOLATE		BIT(4) // don't use, old bug
#define SF_SCRIPT_NOINTERRUPT		BIT(5)
#define SF_SCRIPT_OVERRIDESTATE		BIT(6)
#define SF_SCRIPT_NOSCRIPTMOVEMENT	BIT(7)
#define SF_SCRIPT_FORCELOOPIDLE		BIT(8) // diffusion - when no movement, loop the idle animation if set
