...
//	DECLARE_DATADESC();
	...
	EHANDLE m_hPlayer;
//	EHANDLE m_hTalkTarget; // diffusion - it's in basemonster now
//	float m_flTalkTime;
};
...
// Diffusion - disabled all "taking damage" animations when shooting at this NPC
/*	if ( flDamage > 0 )
	{
...
{
//	UTIL_Ricochet( ptr->vecEndPos, 1.0 );     // Diffusion - removed ricochet effect from NPC model
...
{
	CBaseMonster::PlayScriptedSentence( pszSentence, duration, volume, attenuation, bConcurrent, pListener, NULL );
