...
{
	"footsteps/slosh1.wav",
	"footsteps/slosh2.wav",
	"footsteps/slosh3.wav",
	"footsteps/slosh4.wav",
};
...
void CTentacle :: HandleAnimEvent( MonsterEvent_t *pEvent )
{
	...
	case 3: // start killing swing
		m_iHitDmg = 200;
		// UTIL_EmitAmbientSound( edict(), GetAbsOrigin() + Vector( 0, 0, MyHeight()), "tentacle/te_swing1.wav", 1.0, ATTN_NORM, 0, 100 );
		break;
	...
	case 5: // just "whoosh" sound
		// UTIL_EmitAmbientSound( edict(), GetAbsOrigin() + Vector( 0, 0, MyHeight()), "tentacle/te_swing2.wav", 1.0, ATTN_NORM, 0, 100 );
		break;
	...
	case 7: // roar
		...
		UTIL_EmitAmbientSound( edict(), GetAbsOrigin() + Vector( 0, 0, MyHeight()), sound, 1.0, ATTN_NORM, 0, 100);
		break;
