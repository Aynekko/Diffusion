...
builds a triangle mesh from the actor's first shape, dispatching by geometry type (box, convex mesh, triangle mesh). Returns false for unsupported types
=================
*/
...
returns the geometry type of the actor's first shape
=================
*/
...
returns the number of decomposed triangles
=================
*/
...
returns the decomposed triangle index buffer
=================
*/
...
returns the decomposed vertex buffer
=================
*/
...
emits 8 corner vertices and 12 triangles per box shape of the actor into the vertex and index buffers
=================
*/
...
triangulates each polygon face of a convex mesh into the vertex and index buffers via a triangle fan
=================
*/
...
copies a triangle mesh's vertices and indices into the buffers, handling both 16- and 32-bit index formats
=================
*/
