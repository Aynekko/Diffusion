...
// sounds used from C physics code
	...
	PRECACHE_SOUND ("hits/ric1.wav");
	PRECACHE_SOUND ("hits/ric2.wav");
	PRECACHE_SOUND ("hits/ric3.wav");
	PRECACHE_SOUND ("hits/ric4.wav");
	PRECACHE_SOUND ("hits/ric5.wav");
//
...
//
	...
	for( i = 0; i < SIZEOFARRAY(gDecals); i++ )
