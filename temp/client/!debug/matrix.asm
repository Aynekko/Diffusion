; Listing generated by Microsoft (R) Optimizing Compiler Version 19.00.24247.2 
	...
	TITLE	D:\!DIFFUSION 2020\source code 2022\client-server\game_shared\matrix.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File d:\!diffusion 2020\source code 2022\client-server\game_shared\matrix.cpp
...
?NewtonToQuake@matrix4x4@@QBE?AV1@XZ PROC		; matrix4x4::NewtonToQuake, COMDAT
; _this$ = ecx
...
__$ArrayPad$ = -4					; size = 4
___$ReturnUdt$ = 8					; size = 4
?QuakeToNewton@matrix4x4@@QBE?AV1@XZ PROC		; matrix4x4::QuakeToNewton, COMDAT
; _this$ = ecx
...
___$ReturnUdt$ = 8					; size = 4
_mat2$ = 12						; size = 64
?Concat@matrix4x4@@QAE?AV1@V1@@Z PROC			; matrix4x4::Concat, COMDAT
; _this$ = ecx
...
___$ReturnUdt$ = 8					; size = 4
_mat2$ = 12						; size = 64
?ConcatTransforms@matrix4x4@@QAE?AV1@V1@@Z PROC		; matrix4x4::ConcatTransforms, COMDAT
; _this$ = ecx
...
__$ArrayPad$ = -4					; size = 4
___$ReturnUdt$ = 8					; size = 4
?InvertFull@matrix4x4@@QBE?AV1@XZ PROC			; matrix4x4::InvertFull, COMDAT
; _this$ = ecx
...
__$ArrayPad$ = -4					; size = 4
___$ReturnUdt$ = 8					; size = 4
?Invert@matrix4x4@@QBE?AV1@XZ PROC			; matrix4x4::Invert, COMDAT
; _this$ = ecx
...
_in$ = 8						; size = 4
_out$ = 12						; size = 4
?TransformStandardPlane@matrix4x4@@QAEXABUplane_s@@AAU2@@Z PROC ; matrix4x4::TransformStandardPlane, COMDAT
; _this$ = ecx
...
_in$ = 8						; size = 4
_out$ = 12						; size = 4
?TransformStandardPlane@matrix4x4@@QAEXABUmplane_s@@AAU2@@Z PROC ; matrix4x4::TransformStandardPlane, COMDAT
; _this$ = ecx
...
_in$ = 8						; size = 4
_out$ = 12						; size = 4
?TransformPositivePlane@matrix4x4@@QAEXABUplane_s@@AAU2@@Z PROC ; matrix4x4::TransformPositivePlane, COMDAT
; _this$ = ecx
...
_in$ = 8						; size = 4
_out$ = 12						; size = 4
?TransformPositivePlane@matrix4x4@@QAEXABUmplane_s@@AAU2@@Z PROC ; matrix4x4::TransformPositivePlane, COMDAT
; _this$ = ecx
...
___$ReturnUdt$ = 8					; size = 4
_v$ = 12						; size = 4
?VectorIRotate@matrix4x4@@QBE?AVVector@@ABV2@@Z PROC	; matrix4x4::VectorIRotate, COMDAT
; _this$ = ecx
...
___$ReturnUdt$ = 8					; size = 4
_v$ = 12						; size = 4
?VectorRotate@matrix4x4@@QBE?AVVector@@ABV2@@Z PROC	; matrix4x4::VectorRotate, COMDAT
; _this$ = ecx
...
___$ReturnUdt$ = 8					; size = 4
_v$ = 12						; size = 4
?VectorITransform@matrix4x4@@QBE?AVVector@@ABV2@@Z PROC	; matrix4x4::VectorITransform, COMDAT
; _this$ = ecx
...
___$ReturnUdt$ = 8					; size = 4
_v$ = 12						; size = 4
?VectorTransform@matrix4x4@@QBE?AVVector4D@@ABV2@@Z PROC ; matrix4x4::VectorTransform, COMDAT
; _this$ = ecx
...
___$ReturnUdt$ = 8					; size = 4
_v$ = 12						; size = 4
?VectorTransform@matrix4x4@@QBE?AVVector@@ABV2@@Z PROC	; matrix4x4::VectorTransform, COMDAT
; _this$ = ecx
...
_this$ = -4						; size = 4
___$ReturnUdt$ = 8					; size = 4
?GetQuaternion@matrix4x4@@QAE?AVVector4D@@XZ PROC	; matrix4x4::GetQuaternion, COMDAT
; _this$ = ecx
...
; 486  : 		float r = sqrt(1.0f + trace), inv = 0.5f / r;
	...
	call	_sqrt
	add	esp, 8
	fstp	DWORD PTR _r$8[ebp]
	movss	xmm0, DWORD PTR __real@3f000000
	divss	xmm0, DWORD PTR _r$8[ebp]
...
; 494  : 		float r = sqrt(1.0f + mat[0][0] - mat[1][1] - mat[2][2]), inv = 0.5f / r;
	...
	call	_sqrt
	add	esp, 8
	fstp	DWORD PTR _r$6[ebp]
	movss	xmm0, DWORD PTR __real@3f000000
	divss	xmm0, DWORD PTR _r$6[ebp]
	movss	DWORD PTR _inv$5[ebp], xmm0

; 495  : 		quat[0] = 0.5f * r;

	movss	xmm0, DWORD PTR __real@3f000000
	mulss	xmm0, DWORD PTR _r$6[ebp]
	lea	ecx, DWORD PTR _quat$[ebp]
...
; 502  : 		float r = sqrt(1.0f + mat[1][1] - mat[0][0] - mat[2][2]), inv = 0.5f / r;
	...
	movss	DWORD PTR _inv$3[ebp], xmm0
...
; 503  : 		quat[0] = (mat[0][1] + mat[1][0]) * inv;
	...
	movss	xmm0, DWORD PTR [esi+edi]
	addss	xmm0, DWORD PTR [eax+edx]
	mulss	xmm0, DWORD PTR _inv$3[ebp]
	lea	ecx, DWORD PTR _quat$[ebp]
...
; 510  : 		float r = sqrt(1.0f + mat[2][2] - mat[0][0] - mat[1][1]), inv = 0.5f / r;
	...
	movss	DWORD PTR _inv$1[ebp], xmm0
...
; 511  : 		quat[0] = (mat[2][0] + mat[0][2]) * inv;
	...
	movss	xmm0, DWORD PTR [esi+edi]
	addss	xmm0, DWORD PTR [eax+edx]
	mulss	xmm0, DWORD PTR _inv$1[ebp]
	lea	ecx, DWORD PTR _quat$[ebp]
...
_this$ = -4						; size = 4
_vOther$ = 8						; size = 4
??4matrix4x4@@QAEAAV0@ABV0@@Z PROC			; matrix4x4::operator=, COMDAT
; _this$ = ecx
...
_this$ = -4						; size = 4
_vOther$ = 8						; size = 4
??4matrix4x4@@QAEAAV0@ABVmatrix3x4@@@Z PROC		; matrix4x4::operator=, COMDAT
; _this$ = ecx
...
_this$ = -4						; size = 4
_vOther$ = 8						; size = 4
??4matrix4x4@@QAEAAV0@ABVmatrix3x3@@@Z PROC		; matrix4x4::operator=, COMDAT
; _this$ = ecx
...
_y$ = 12						; size = 4
_z$ = 16						; size = 4
?CreateScale@matrix4x4@@QAEXMMM@Z PROC			; matrix4x4::CreateScale, COMDAT
; _this$ = ecx
...
_this$ = -4						; size = 4
_scale$ = 8						; size = 4
?CreateScale@matrix4x4@@QAEXM@Z PROC			; matrix4x4::CreateScale, COMDAT
; _this$ = ecx
...
_y$ = 16						; size = 4
_z$ = 20						; size = 4
?CreateRotate@matrix4x4@@QAEXMMMM@Z PROC		; matrix4x4::CreateRotate, COMDAT
; _this$ = ecx
...
_y$ = 12						; size = 4
_z$ = 16						; size = 4
?CreateTranslate@matrix4x4@@QAEXMMM@Z PROC		; matrix4x4::CreateTranslate, COMDAT
; _this$ = ecx
...
_zNear$ = 24						; size = 4
_zFar$ = 28						; size = 4
?CreateOrtho@matrix4x4@@QAEXMMMMMM@Z PROC		; matrix4x4::CreateOrtho, COMDAT
; _this$ = ecx
...
_zNear$ = 24						; size = 4
_zFar$ = 28						; size = 4
?CreateProjection@matrix4x4@@QAEXMMMMMM@Z PROC		; matrix4x4::CreateProjection, COMDAT
; _this$ = ecx
...
_zNear$ = 16						; size = 4
_zFar$ = 20						; size = 4
?CreateProjection@matrix4x4@@QAEXMMMM@Z PROC		; matrix4x4::CreateProjection, COMDAT
; _this$ = ecx
...
_TEXT	SEGMENT
_this$ = -4						; size = 4
?CreateTexture@matrix4x4@@QAEXXZ PROC			; matrix4x4::CreateTexture, COMDAT
; _this$ = ecx
...
_TEXT	SEGMENT
_this$ = -4						; size = 4
?CreateModelview@matrix4x4@@QAEXXZ PROC			; matrix4x4::CreateModelview, COMDAT
; _this$ = ecx
...
$T4 = -84						; size = 16
_this$ = -4						; size = 4
?Identity@matrix4x4@@QAEXXZ PROC			; matrix4x4::Identity, COMDAT
; _this$ = ecx
...
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0matrix4x4@@QAE@XZ PROC				; matrix4x4::matrix4x4, COMDAT
; _this$ = ecx
...
___$ReturnUdt$ = 8					; size = 4
_mat2$ = 12						; size = 48
?ConcatTransforms@matrix3x4@@QBE?AV1@V1@@Z PROC		; matrix3x4::ConcatTransforms, COMDAT
; _this$ = ecx
...
___$ReturnUdt$ = 8					; size = 4
_mat2$ = 12						; size = 48
?ConcatTransforms@matrix3x4@@QAE?AV1@V1@@Z PROC		; matrix3x4::ConcatTransforms, COMDAT
; _this$ = ecx
...
__$ArrayPad$ = -4					; size = 4
___$ReturnUdt$ = 8					; size = 4
?Invert@matrix3x4@@QBE?AV1@XZ PROC			; matrix3x4::Invert, COMDAT
; _this$ = ecx
...
___$ReturnUdt$ = 8					; size = 4
_v$ = 12						; size = 4
?VectorIRotate@matrix3x4@@QBE?AVVector@@ABV2@@Z PROC	; matrix3x4::VectorIRotate, COMDAT
; _this$ = ecx
...
___$ReturnUdt$ = 8					; size = 4
_v$ = 12						; size = 4
?VectorRotate@matrix3x4@@QBE?AVVector@@ABV2@@Z PROC	; matrix3x4::VectorRotate, COMDAT
; _this$ = ecx
...
___$ReturnUdt$ = 8					; size = 4
_v$ = 12						; size = 4
?VectorITransform@matrix3x4@@QBE?AVVector@@ABV2@@Z PROC	; matrix3x4::VectorITransform, COMDAT
; _this$ = ecx
...
___$ReturnUdt$ = 8					; size = 4
_v$ = 12						; size = 4
?VectorTransform@matrix3x4@@QBE?AVVector@@ABV2@@Z PROC	; matrix3x4::VectorTransform, COMDAT
; _this$ = ecx
...
_this$ = -4						; size = 4
___$ReturnUdt$ = 8					; size = 4
?GetQuaternion@matrix3x4@@QAE?AVVector4D@@XZ PROC	; matrix3x4::GetQuaternion, COMDAT
; _this$ = ecx
...
_this$ = -4						; size = 4
_vOther$ = 8						; size = 4
??4matrix3x4@@QAEAAV0@ABVmatrix4x4@@@Z PROC		; matrix3x4::operator=, COMDAT
; _this$ = ecx
...
_this$ = -4						; size = 4
_vOther$ = 8						; size = 4
??4matrix3x4@@QAEAAV0@ABVmatrix3x3@@@Z PROC		; matrix3x4::operator=, COMDAT
; _this$ = ecx
...
$T4 = -80						; size = 12
_this$ = -4						; size = 4
?Identity@matrix3x4@@QAEXXZ PROC			; matrix3x4::Identity, COMDAT
; _this$ = ecx
...
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0matrix3x4@@QAE@XZ PROC				; matrix3x4::matrix3x4, COMDAT
; _this$ = ecx
...
___$ReturnUdt$ = 8					; size = 4
_mat2$ = 12						; size = 36
?Concat@matrix3x3@@QAE?AV1@V1@@Z PROC			; matrix3x3::Concat, COMDAT
; _this$ = ecx
...
___$ReturnUdt$ = 8					; size = 4
_v$ = 12						; size = 4
?VectorIRotate@matrix3x3@@QBE?AVVector@@ABV2@@Z PROC	; matrix3x3::VectorIRotate, COMDAT
; _this$ = ecx
...
___$ReturnUdt$ = 8					; size = 4
_v$ = 12						; size = 4
?VectorRotate@matrix3x3@@QBE?AVVector@@ABV2@@Z PROC	; matrix3x3::VectorRotate, COMDAT
; _this$ = ecx
...
_this$ = -4						; size = 4
___$ReturnUdt$ = 8					; size = 4
?GetQuaternion@matrix3x3@@QAE?AVVector4D@@XZ PROC	; matrix3x3::GetQuaternion, COMDAT
; _this$ = ecx
...
_this$ = -4						; size = 4
_forward$ = 8						; size = 4
?FromVector@matrix3x3@@QAEXABVVector@@@Z PROC		; matrix3x3::FromVector, COMDAT
; _this$ = ecx
...
_this$ = -4						; size = 4
_vOther$ = 8						; size = 4
??4matrix3x3@@QAEAAV0@ABVmatrix4x4@@@Z PROC		; matrix3x3::operator=, COMDAT
; _this$ = ecx
...
_this$ = -4						; size = 4
_vOther$ = 8						; size = 4
??4matrix3x3@@QAEAAV0@ABVmatrix3x4@@@Z PROC		; matrix3x3::operator=, COMDAT
; _this$ = ecx
...
$T3 = -80						; size = 12
_this$ = -4						; size = 4
?Identity@matrix3x3@@QAEXXZ PROC			; matrix3x3::Identity, COMDAT
; _this$ = ecx
...
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0matrix3x3@@QAE@XZ PROC				; matrix3x3::matrix3x3, COMDAT
; _this$ = ecx
