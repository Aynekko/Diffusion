; Listing generated by Microsoft (R) Optimizing Compiler Version 19.00.24247.2 
	...
	TITLE	D:\!DIFFUSION 2020\source code 2022\client-server\game_shared\stringlib.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?Q_atov@@YAXPAMPBDI@Z				; Q_atov
...
PUBLIC	??_C@_03FBAAJIGL@?5Mb?$AA@			; `string'
PUBLIC	??_C@_03FFINOENJ@?5Kb?$AA@			; `string'
PUBLIC	??_C@_06LCIDCBMH@?5bytes?$AA@			; `string'
PUBLIC	??_C@_04EMEGLOCB@?$CFi?$CFs?$AA@		; `string'
PUBLIC	??_C@_08BIBOIFBG@?$CF?$CF?4?$CFif?$CFs?$AA@	; `string'
...
CONST	ENDS
;	COMDAT ??_C@_08BIBOIFBG@?$CF?$CF?4?$CFif?$CFs?$AA@
CONST	SEGMENT
??_C@_08BIBOIFBG@?$CF?$CF?4?$CFif?$CFs?$AA@ DB '%%.%if%s', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_04EMEGLOCB@?$CFi?$CFs?$AA@
CONST	SEGMENT
??_C@_04EMEGLOCB@?$CFi?$CFs?$AA@ DB '%i%s', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_06LCIDCBMH@?5bytes?$AA@
CONST	SEGMENT
??_C@_06LCIDCBMH@?5bytes?$AA@ DB ' bytes', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_03FFINOENJ@?5Kb?$AA@
CONST	SEGMENT
??_C@_03FFINOENJ@?5Kb?$AA@ DB ' Kb', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_03FBAAJIGL@?5Mb?$AA@
CONST	SEGMENT
??_C@_03FBAAJIGL@?5Mb?$AA@ DB ' Mb', 00H		; `string'
CONST	ENDS
...
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File d:\!diffusion 2020\source code 2022\client-server\game_shared\stringlib.cpp
;	COMDAT ?va@@YAPADPBDZZ
_TEXT	SEGMENT
_argptr$ = -4						; size = 4
_format$ = 8						; size = 4
?va@@YAPADPBDZZ PROC					; va, COMDAT
...
; 503  : 	stringindex = (stringindex + 1) & 63;
	...
	mov	DWORD PTR ?stringindex@?1??va@@YAPADPBDZZ@4HA, eax
...
?Q_pretifymem@@YAPADMH@Z PROC				; Q_pretifymem, COMDAT
...
; 522  : 	current = ( current + 1 ) & ( 8 - 1 );
	...
	add	eax, 1
	and	eax, 7
	mov	DWORD PTR ?current@?1??Q_pretifymem@@YAPADMH@Z@4HA, eax
...
; 528  : 		Q_sprintf( suffix, " Mb" );
	...
	push	OFFSET ??_C@_03FBAAJIGL@?5Mb?$AA@
...
; 533  : 		Q_sprintf( suffix, " Kb" );
	...
	push	OFFSET ??_C@_03FFINOENJ@?5Kb?$AA@
	lea	eax, DWORD PTR _suffix$[ebp]
	push	eax
	call	?Q_sprintf@@YAHPADPBDZZ			; Q_sprintf
	add	esp, 8
...
; 535  : 	else Q_sprintf( suffix, " bytes" );
	...
	push	OFFSET ??_C@_06LCIDCBMH@?5bytes?$AA@
	lea	eax, DWORD PTR _suffix$[ebp]
	push	eax
	call	?Q_sprintf@@YAHPADPBDZZ			; Q_sprintf
	add	esp, 8
...
; 543  : 		Q_sprintf( val, "%i%s", (int)value, suffix );
	...
	push	ecx
	push	OFFSET ??_C@_04EMEGLOCB@?$CFi?$CFs?$AA@
...
; 550  : 		Q_sprintf( fmt, "%%.%if%s", digitsafterdecimal, suffix );
	...
	push	ecx
	push	OFFSET ??_C@_08BIBOIFBG@?$CF?$CF?4?$CFif?$CFs?$AA@
...
_buffer$ = 8						; size = 4
_format$ = 12						; size = 4
?Q_sprintf@@YAHPADPBDZZ PROC				; Q_sprintf, COMDAT
...
_format$ = 16						; size = 4
?Q_snprintf@@YAHPADIPBDZZ PROC				; Q_snprintf, COMDAT
...
_format$ = 16						; size = 4
_args$ = 20						; size = 4
?Q_vsnprintf@@YAHPADIPBD0@Z PROC			; Q_vsnprintf, COMDAT
...
_string$ = 8						; size = 4
_string2$ = 12						; size = 4
?Q_stristr@@YAPADPBD0@Z PROC				; Q_stristr, COMDAT
...
_string$ = 8						; size = 4
_string2$ = 12						; size = 4
?Q_strstr@@YAPADPBD0@Z PROC				; Q_strstr, COMDAT
...
_s2$ = 12						; size = 4
_n$ = 16						; size = 4
?Q_strncmp@@YAHPBD0H@Z PROC				; Q_strncmp, COMDAT
...
_s2$ = 12						; size = 4
_n$ = 16						; size = 4
?Q_strnicmp@@YAHPBD0H@Z PROC				; Q_strnicmp, COMDAT
...
_s$ = 8							; size = 4
_c$ = 12						; size = 1
?Q_strrchr@@YAPADPBDD@Z PROC				; Q_strrchr, COMDAT
...
_s$ = 8							; size = 4
_c$ = 12						; size = 1
?Q_strchr@@YAPADPBDD@Z PROC				; Q_strchr, COMDAT
...
_str$ = 12						; size = 4
_siz$ = 16						; size = 4
?Q_atov@@YAXPAMPBDI@Z PROC				; Q_atov, COMDAT
...
; 302  : 	memset( vec, 0, sizeof( float ) * siz );
...
; 317  : }
	...
	pop	ebp
	ret	0
?Q_atov@@YAXPAMPBDI@Z ENDP				; Q_atov
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File d:\!diffusion 2020\source code 2022\client-server\game_shared\stringlib.cpp
...
_val$ = -8						; size = 8
_str$ = 8						; size = 4
?Q_atof@@YAMPBD@Z PROC					; Q_atof, COMDAT
...
_val$ = -4						; size = 4
_str$ = 8						; size = 4
?Q_atoi@@YAHPBD@Z PROC					; Q_atoi, COMDAT
...
_b$ = -4						; size = 4
_s$ = 8							; size = 4
?copystring@@YAPADPBD@Z PROC				; copystring, COMDAT
...
_src$ = 12						; size = 4
_size$ = 16						; size = 4
?Q_strncpy@@YAIPADPBDI@Z PROC				; Q_strncpy, COMDAT
...
_src$ = 12						; size = 4
_size$ = 16						; size = 4
?Q_strncat@@YAIPADPBDI@Z PROC				; Q_strncat, COMDAT
...
_out$ = -1						; size = 1
_in$ = 8						; size = 1
?Q_tolower@@YADD@Z PROC					; Q_tolower, COMDAT
...
_out$ = -1						; size = 1
_in$ = 8						; size = 1
?Q_toupper@@YADD@Z PROC					; Q_toupper, COMDAT
...
_len$ = -4						; size = 4
_string$ = 8						; size = 4
?Q_strlen@@YAHPBD@Z PROC				; Q_strlen, COMDAT
...
_TEXT	SEGMENT
_str$ = 8						; size = 4
?Q_isdigit@@YA_NPBD@Z PROC				; Q_isdigit, COMDAT
...
_out$ = 12						; size = 4
_size_out$ = 16						; size = 4
?Q_strnlwr@@YAXPBDPADI@Z PROC				; Q_strnlwr, COMDAT
...
_out$ = 12						; size = 4
_size_out$ = 16						; size = 4
?Q_strnupr@@YAXPBDPADI@Z PROC				; Q_strnupr, COMDAT
...
_separator$ = -4					; size = 4
_in$ = 8						; size = 4
?UTIL_FileExtension@@YAPBDPBD@Z PROC			; UTIL_FileExtension, COMDAT
