; Listing generated by Microsoft (R) Optimizing Compiler Version 19.00.24247.2 
	...
	TITLE	D:\!DIFFUSION 2020\source code 2022\client-server\server\entities\env_rope.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??_C@_0BA@PLILAGA@items?1rope1?4wav?$AA@	; `string'
PUBLIC	??_C@_0BA@IJCMMCMO@items?1rope2?4wav?$AA@	; `string'
PUBLIC	??_C@_0BA@ECHABBGL@items?1rope3?4wav?$AA@	; `string'
PUBLIC	??_C@_05KKBMKKNC@CRope?$AA@			; `string'
PUBLIC	??_C@_0M@NHNBJ@m_iSegments?$AA@			; `string'
PUBLIC	??_C@_08GPGJEGMF@segments?$AA@			; `string'
PUBLIC	??_C@_0BA@GAELLLHC@m_vecLastEndPos?$AA@		; `string'
PUBLIC	??_C@_0N@LFLCFFBJ@m_vecGravity?$AA@		; `string'
PUBLIC	??_C@_0O@DHDOPDCL@m_iNumSamples?$AA@		; `string'
PUBLIC	??_C@_0BB@KJJGGJNB@m_bSimulateBones?$AA@	; `string'
PUBLIC	??_C@_0BC@KKAIAEJO@m_bObjectAttached?$AA@	; `string'
PUBLIC	??_C@_0BK@PJFMBDOE@m_iAttachedObjectsSegment?$AA@ ; `string'
PUBLIC	??_C@_0P@JFNMKGP@m_flDetachTime?$AA@		; `string'
PUBLIC	??_C@_0M@NLLGNHDL@m_pSegments?$AA@		; `string'
PUBLIC	??_C@_0BM@JAHKKMG@m_bDisallowPlayerAttachment?$AA@ ; `string'
PUBLIC	??_C@_07DBNODEFN@disable?$AA@			; `string'
PUBLIC	??_C@_0P@IOMMCLBC@m_iszBodyModel?$AA@		; `string'
PUBLIC	??_C@_09PLPEIHCE@bodymodel?$AA@			; `string'
PUBLIC	??_C@_0BB@KBHLBBGD@m_iszEndingModel?$AA@	; `string'
PUBLIC	??_C@_0M@JNNHNIN@endingmodel?$AA@		; `string'
PUBLIC	??_C@_0BK@NKMOPMG@m_flAttachedObjectsOffset?$AA@ ; `string'
PUBLIC	??_C@_0N@FBBKNGD@m_bMakeSound?$AA@		; `string'
PUBLIC	??_C@_0N@HAILOFJG@CRopeSegment?$AA@		; `string'
PUBLIC	?m_DataMap@CRope@@2Udatamap_s@@A		; CRope::m_DataMap
PUBLIC	??_C@_0P@HOHEMMB@m_iszModelName?$AA@		; `string'
PUBLIC	??_C@_0P@NKAIAECK@m_bCauseDamage?$AA@		; `string'
PUBLIC	??_C@_0BA@PBDAONB@m_bCanBeGrabbed?$AA@		; `string'
PUBLIC	??_C@_0BC@FDEAJGN@m_Data?4restLength?$AA@	; `string'
PUBLIC	??_C@_0BB@CIPGLNC@m_Data?4mPosition?$AA@	; `string'
PUBLIC	??_C@_0BB@GAKKICDP@m_Data?4mVelocity?$AA@	; `string'
PUBLIC	??_C@_0O@HKMPDIFM@m_Data?4mForce?$AA@		; `string'
PUBLIC	??_C@_0BG@CIIOHODL@m_Data?4mExternalForce?$AA@	; `string'
PUBLIC	??_C@_0BL@NPKKAFDI@m_Data?4mApplyExternalForce?$AA@ ; `string'
PUBLIC	??_C@_0BH@BCLICKBO@m_Data?4mMassReciprocal?$AA@	; `string'
PUBLIC	??_C@_0O@CPJHACOC@m_pMasterRope?$AA@		; `string'
PUBLIC	?m_DataMap@CRopeSegment@@2Udatamap_s@@A		; CRopeSegment::m_DataMap
;	COMDAT ??_C@_0O@CPJHACOC@m_pMasterRope?$AA@
CONST	SEGMENT
??_C@_0O@CPJHACOC@m_pMasterRope?$AA@ DB 'm_pMasterRope', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BH@BCLICKBO@m_Data?4mMassReciprocal?$AA@
CONST	SEGMENT
??_C@_0BH@BCLICKBO@m_Data?4mMassReciprocal?$AA@ DB 'm_Data.mMassReciproca'
	DB	'l', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0BL@NPKKAFDI@m_Data?4mApplyExternalForce?$AA@
CONST	SEGMENT
??_C@_0BL@NPKKAFDI@m_Data?4mApplyExternalForce?$AA@ DB 'm_Data.mApplyExte'
	DB	'rnalForce', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BG@CIIOHODL@m_Data?4mExternalForce?$AA@
CONST	SEGMENT
??_C@_0BG@CIIOHODL@m_Data?4mExternalForce?$AA@ DB 'm_Data.mExternalForce', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0O@HKMPDIFM@m_Data?4mForce?$AA@
CONST	SEGMENT
??_C@_0O@HKMPDIFM@m_Data?4mForce?$AA@ DB 'm_Data.mForce', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BB@GAKKICDP@m_Data?4mVelocity?$AA@
CONST	SEGMENT
??_C@_0BB@GAKKICDP@m_Data?4mVelocity?$AA@ DB 'm_Data.mVelocity', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BB@CIPGLNC@m_Data?4mPosition?$AA@
CONST	SEGMENT
??_C@_0BB@CIPGLNC@m_Data?4mPosition?$AA@ DB 'm_Data.mPosition', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BC@FDEAJGN@m_Data?4restLength?$AA@
CONST	SEGMENT
??_C@_0BC@FDEAJGN@m_Data?4restLength?$AA@ DB 'm_Data.restLength', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BA@PBDAONB@m_bCanBeGrabbed?$AA@
CONST	SEGMENT
??_C@_0BA@PBDAONB@m_bCanBeGrabbed?$AA@ DB 'm_bCanBeGrabbed', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0P@NKAIAECK@m_bCauseDamage?$AA@
CONST	SEGMENT
??_C@_0P@NKAIAECK@m_bCauseDamage?$AA@ DB 'm_bCauseDamage', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0P@HOHEMMB@m_iszModelName?$AA@
CONST	SEGMENT
??_C@_0P@HOHEMMB@m_iszModelName?$AA@ DB 'm_iszModelName', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@HAILOFJG@CRopeSegment?$AA@
CONST	SEGMENT
??_C@_0N@HAILOFJG@CRopeSegment?$AA@ DB 'CRopeSegment', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@FBBKNGD@m_bMakeSound?$AA@
CONST	SEGMENT
??_C@_0N@FBBKNGD@m_bMakeSound?$AA@ DB 'm_bMakeSound', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BK@NKMOPMG@m_flAttachedObjectsOffset?$AA@
CONST	SEGMENT
??_C@_0BK@NKMOPMG@m_flAttachedObjectsOffset?$AA@ DB 'm_flAttachedObjectsO'
	DB	'ffset', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0M@JNNHNIN@endingmodel?$AA@
CONST	SEGMENT
??_C@_0M@JNNHNIN@endingmodel?$AA@ DB 'endingmodel', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0BB@KBHLBBGD@m_iszEndingModel?$AA@
CONST	SEGMENT
??_C@_0BB@KBHLBBGD@m_iszEndingModel?$AA@ DB 'm_iszEndingModel', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_09PLPEIHCE@bodymodel?$AA@
CONST	SEGMENT
??_C@_09PLPEIHCE@bodymodel?$AA@ DB 'bodymodel', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0P@IOMMCLBC@m_iszBodyModel?$AA@
CONST	SEGMENT
??_C@_0P@IOMMCLBC@m_iszBodyModel?$AA@ DB 'm_iszBodyModel', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_07DBNODEFN@disable?$AA@
CONST	SEGMENT
??_C@_07DBNODEFN@disable?$AA@ DB 'disable', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0BM@JAHKKMG@m_bDisallowPlayerAttachment?$AA@
CONST	SEGMENT
??_C@_0BM@JAHKKMG@m_bDisallowPlayerAttachment?$AA@ DB 'm_bDisallowPlayerA'
	DB	'ttachment', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0M@NLLGNHDL@m_pSegments?$AA@
CONST	SEGMENT
??_C@_0M@NLLGNHDL@m_pSegments?$AA@ DB 'm_pSegments', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0P@JFNMKGP@m_flDetachTime?$AA@
CONST	SEGMENT
??_C@_0P@JFNMKGP@m_flDetachTime?$AA@ DB 'm_flDetachTime', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BK@PJFMBDOE@m_iAttachedObjectsSegment?$AA@
CONST	SEGMENT
??_C@_0BK@PJFMBDOE@m_iAttachedObjectsSegment?$AA@ DB 'm_iAttachedObjectsS'
	DB	'egment', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BC@KKAIAEJO@m_bObjectAttached?$AA@
CONST	SEGMENT
??_C@_0BC@KKAIAEJO@m_bObjectAttached?$AA@ DB 'm_bObjectAttached', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BB@KJJGGJNB@m_bSimulateBones?$AA@
CONST	SEGMENT
??_C@_0BB@KJJGGJNB@m_bSimulateBones?$AA@ DB 'm_bSimulateBones', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0O@DHDOPDCL@m_iNumSamples?$AA@
CONST	SEGMENT
??_C@_0O@DHDOPDCL@m_iNumSamples?$AA@ DB 'm_iNumSamples', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@LFLCFFBJ@m_vecGravity?$AA@
CONST	SEGMENT
??_C@_0N@LFLCFFBJ@m_vecGravity?$AA@ DB 'm_vecGravity', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BA@GAELLLHC@m_vecLastEndPos?$AA@
CONST	SEGMENT
??_C@_0BA@GAELLLHC@m_vecLastEndPos?$AA@ DB 'm_vecLastEndPos', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_08GPGJEGMF@segments?$AA@
CONST	SEGMENT
??_C@_08GPGJEGMF@segments?$AA@ DB 'segments', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0M@NHNBJ@m_iSegments?$AA@
CONST	SEGMENT
??_C@_0M@NHNBJ@m_iSegments?$AA@ DB 'm_iSegments', 00H	; `string'
CONST	ENDS
_DATA	SEGMENT
?dataDesc@?1???$DataMapInit@VCRope@@@@YAPAUdatamap_s@@PAVCRope@@@Z@4PAUtypedescription_s@@A DD 012H ; `DataMapInit<CRope>'::`2'::dataDesc
	...
	DD	00H
	DD	0aH
	DD	FLAT:??_C@_0M@NHNBJ@m_iSegments?$AA@
	DD	0728H
	DW	01H
	DW	06H
	DD	FLAT:??_C@_08GPGJEGMF@segments?$AA@
	DD	00H
	DD	08H
	DD	FLAT:??_C@_0BA@GAELLLHC@m_vecLastEndPos?$AA@
	DD	0730H
	DW	01H
	DW	02H
	DD	00H
	DD	00H
	DD	07H
	DD	FLAT:??_C@_0N@LFLCFFBJ@m_vecGravity?$AA@
	DD	073cH
	DW	01H
	DW	02H
	DD	00H
	DD	00H
	DD	0aH
	DD	FLAT:??_C@_0O@DHDOPDCL@m_iNumSamples?$AA@
	DD	072cH
	DW	01H
	DW	02H
	DD	00H
	DD	00H
	DD	0cH
	DD	FLAT:??_C@_0BB@KJJGGJNB@m_bSimulateBones?$AA@
	DD	0864H
	DW	01H
	DW	02H
	DD	00H
	DD	00H
	DD	0cH
	DD	FLAT:??_C@_0BC@KKAIAEJO@m_bObjectAttached?$AA@
	DD	0854H
	DW	01H
	DW	02H
	DD	00H
	DD	00H
	DD	0aH
	DD	FLAT:??_C@_0BK@PJFMBDOE@m_iAttachedObjectsSegment?$AA@
	DD	0848H
	DW	01H
	DW	02H
	DD	00H
	DD	00H
	DD	0fH
	DD	FLAT:??_C@_0P@JFNMKGP@m_flDetachTime?$AA@
	DD	0858H
	DW	01H
	DW	02H
	DD	00H
	DD	00H
	DD	03H
	DD	FLAT:??_C@_0M@NLLGNHDL@m_pSegments?$AA@
	DD	0748H
	DW	040H
	DW	02H
	DD	00H
	DD	00H
	DD	0cH
	DD	FLAT:??_C@_0BM@JAHKKMG@m_bDisallowPlayerAttachment?$AA@
	DD	084cH
	DW	01H
	DW	06H
	DD	FLAT:??_C@_07DBNODEFN@disable?$AA@
	DD	00H
	DD	01H
	DD	FLAT:??_C@_0P@IOMMCLBC@m_iszBodyModel?$AA@
	DD	085cH
	DW	01H
	DW	06H
	DD	FLAT:??_C@_09PLPEIHCE@bodymodel?$AA@
	DD	00H
	DD	01H
	DD	FLAT:??_C@_0BB@KBHLBBGD@m_iszEndingModel?$AA@
	DD	0860H
	DW	01H
	DW	06H
	DD	FLAT:??_C@_0M@JNNHNIN@endingmodel?$AA@
	DD	00H
	DD	00H
	DD	FLAT:??_C@_0BK@NKMOPMG@m_flAttachedObjectsOffset?$AA@
	DD	0850H
	DW	01H
	DW	02H
	DD	00H
	DD	00H
	DD	0cH
	DD	FLAT:??_C@_0N@FBBKNGD@m_bMakeSound?$AA@
	DD	0865H
	DW	01H
	DW	02H
	DD	00H
...
?dataDesc@?1???$DataMapInit@VCRopeSegment@@@@YAPAUdatamap_s@@PAVCRopeSegment@@@Z@4PAUtypedescription_s@@A DD 012H ; `DataMapInit<CRopeSegment>'::`2'::dataDesc
	...
	DD	00H
	DD	01H
	DD	FLAT:??_C@_0P@HOHEMMB@m_iszModelName?$AA@
	DD	0780H
	DW	01H
	DW	02H
	DD	00H
	DD	00H
	DD	0cH
	DD	FLAT:??_C@_0P@NKAIAECK@m_bCauseDamage?$AA@
	DD	0784H
	DW	01H
	DW	02H
	DD	00H
	DD	00H
	DD	0cH
	DD	FLAT:??_C@_0BA@PBDAONB@m_bCanBeGrabbed?$AA@
	DD	0785H
	DW	01H
	DW	02H
	DD	00H
	DD	00H
	DD	00H
	DD	FLAT:??_C@_0BC@FDEAJGN@m_Data?4restLength?$AA@
	DD	0778H
	DW	01H
	DW	02H
	DD	00H
	DD	00H
	DD	07H
	DD	FLAT:??_C@_0BB@CIPGLNC@m_Data?4mPosition?$AA@
	DD	0740H
	DW	01H
	DW	02H
	DD	00H
	DD	00H
	DD	07H
	DD	FLAT:??_C@_0BB@GAKKICDP@m_Data?4mVelocity?$AA@
	DD	074cH
	DW	01H
	DW	02H
	DD	00H
	DD	00H
	DD	07H
	DD	FLAT:??_C@_0O@HKMPDIFM@m_Data?4mForce?$AA@
	DD	0758H
	DW	01H
	DW	02H
	DD	00H
	DD	00H
	DD	07H
	DD	FLAT:??_C@_0BG@CIIOHODL@m_Data?4mExternalForce?$AA@
	DD	0764H
	DW	01H
	DW	02H
	DD	00H
	DD	00H
	DD	0cH
	DD	FLAT:??_C@_0BL@NPKKAFDI@m_Data?4mApplyExternalForce?$AA@
	DD	0770H
	DW	01H
	DW	02H
	DD	00H
	DD	00H
	DD	00H
	DD	FLAT:??_C@_0BH@BCLICKBO@m_Data?4mMassReciprocal?$AA@
	DD	0774H
	DW	01H
	DW	02H
	DD	00H
	DD	00H
	DD	03H
	DD	FLAT:??_C@_0O@CPJHACOC@m_pMasterRope?$AA@
	DD	077cH
	DW	01H
	DW	02H
	DD	00H
...
?m_DataMap@CRope@@2Udatamap_s@@A DD 00H			; CRope::m_DataMap
	DD	00H
	DD	FLAT:??_C@_05KKBMKKNC@CRope?$AA@
	DD	00H
?m_DataMap@CRopeSegment@@2Udatamap_s@@A DD 00H		; CRopeSegment::m_DataMap
	DD	00H
	DD	FLAT:??_C@_0N@HAILOFJG@CRopeSegment?$AA@
	DD	00H
_DATA	ENDS
;	COMDAT ??_C@_05KKBMKKNC@CRope?$AA@
CONST	SEGMENT
??_C@_05KKBMKKNC@CRope?$AA@ DB 'CRope', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0BA@ECHABBGL@items?1rope3?4wav?$AA@
CONST	SEGMENT
??_C@_0BA@ECHABBGL@items?1rope3?4wav?$AA@ DB 'items/rope3.wav', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BA@IJCMMCMO@items?1rope2?4wav?$AA@
CONST	SEGMENT
??_C@_0BA@IJCMMCMO@items?1rope2?4wav?$AA@ DB 'items/rope2.wav', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BA@PLILAGA@items?1rope1?4wav?$AA@
CONST	SEGMENT
??_C@_0BA@PLILAGA@items?1rope1?4wav?$AA@ DB 'items/rope1.wav', 00H ; `string'
CONST	ENDS
CONST	SEGMENT
?g_pszCreakSounds@@3QBQBDB DD FLAT:??_C@_0BA@PLILAGA@items?1rope1?4wav?$AA@ ; g_pszCreakSounds
	DD	FLAT:??_C@_0BA@IJCMMCMO@items?1rope2?4wav?$AA@
	DD	FLAT:??_C@_0BA@ECHABBGL@items?1rope3?4wav?$AA@
CONST	ENDS
...
PUBLIC	??_C@_08BECPGBEI@env_rope?$AA@			; `string'
PUBLIC	??_C@_0BC@GNIPEJAC@models?1rope16?4mdl?$AA@	; `string'
...
PUBLIC	??_C@_0N@JOACLEGN@rope_segment?$AA@		; `string'
PUBLIC	??_C@_0BE@OFPDCNNA@items?1grab_rope?4wav?$AA@	; `string'
...
?$TSS0@?1???$DataMapInit@VCRope@@@@YAPAUdatamap_s@@PAVCRope@@@Z@4HA DD 01H DUP (?) ; `DataMapInit<CRope>'::`2'::$TSS0
...
?$TSS0@?1???$DataMapInit@VCRopeSegment@@@@YAPAUdatamap_s@@PAVCRopeSegment@@@Z@4HA DD 01H DUP (?) ; `DataMapInit<CRopeSegment>'::`2'::$TSS0
...
CONST	ENDS
;	COMDAT ??_C@_0BE@OFPDCNNA@items?1grab_rope?4wav?$AA@
CONST	SEGMENT
??_C@_0BE@OFPDCNNA@items?1grab_rope?4wav?$AA@ DB 'items/grab_rope.wav', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@JOACLEGN@rope_segment?$AA@
CONST	SEGMENT
??_C@_0N@JOACLEGN@rope_segment?$AA@ DB 'rope_segment', 00H ; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_0BC@GNIPEJAC@models?1rope16?4mdl?$AA@
CONST	SEGMENT
??_C@_0BC@GNIPEJAC@models?1rope16?4mdl?$AA@ DB 'models/rope16.mdl', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_08BECPGBEI@env_rope?$AA@
CONST	SEGMENT
??_C@_08BECPGBEI@env_rope?$AA@ DB 'env_rope', 00H	; `string'
CONST	ENDS
...
; Function compile flags: /Odtp /ZI
; File d:\!diffusion 2020\source code 2022\client-server\server\entities\env_rope.cpp
;	COMDAT ??__Erope_segment@@YAXXZ
text$di	SEGMENT
??__Erope_segment@@YAXXZ PROC				; `dynamic initializer for 'rope_segment'', COMDAT

; 849  : LINK_ENTITY_TO_CLASS(rope_segment, CRopeSegment);
	...
	push	esi
	push	edi
	push	OFFSET ??_C@_0N@JOACLEGN@rope_segment?$AA@
...
; 835  : BEGIN_DATADESC(CRopeSegment)
...
; Function compile flags: /Odtp /ZI
; File d:\!diffusion 2020\source code 2022\client-server\server\entities\env_rope.cpp
;	COMDAT ??$DataMapInit@VCRopeSegment@@@@YAPAUdatamap_s@@PAVCRopeSegment@@@Z
_TEXT	SEGMENT
__$EHRec$ = -12						; size = 12
___formal$ = 8						; size = 4
??$DataMapInit@VCRopeSegment@@@@YAPAUdatamap_s@@PAVCRopeSegment@@@Z PROC ; DataMapInit<CRopeSegment>, COMDAT
...
; 835  : BEGIN_DATADESC(CRopeSegment)
	...
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	push	OFFSET ??_C@_0N@HAILOFJG@CRopeSegment?$AA@
	mov	ecx, OFFSET ?nameHolder@?1???$DataMapInit@VCRopeSegment@@@@YAPAUdatamap_s@@PAVCRopeSegment@@@Z@4VCDatadescGeneratedNameHolder@@A
...
; 836  : DEFINE_FIELD(m_iszModelName, FIELD_STRING),
; 837  : DEFINE_FIELD(m_bCauseDamage, FIELD_BOOLEAN),
; 838  : DEFINE_FIELD(m_bCanBeGrabbed, FIELD_BOOLEAN),
; 839  : DEFINE_FIELD(m_Data.restLength, FIELD_FLOAT),
; 840  : DEFINE_FIELD(m_Data.mPosition, FIELD_VECTOR),
; 841  : DEFINE_FIELD(m_Data.mVelocity, FIELD_VECTOR),
; 842  : DEFINE_FIELD(m_Data.mForce, FIELD_VECTOR),
; 843  : DEFINE_FIELD(m_Data.mExternalForce, FIELD_VECTOR),
; 844  : DEFINE_FIELD(m_Data.mApplyExternalForce, FIELD_BOOLEAN),
; 845  : DEFINE_FIELD(m_Data.mMassReciprocal, FIELD_FLOAT),
; 846  : DEFINE_FIELD(m_pMasterRope, FIELD_CLASSPTR),
; 847  : END_DATADESC()
	...
	shl	eax, 0
	add	eax, OFFSET ?dataDesc@?1???$DataMapInit@VCRopeSegment@@@@YAPAUdatamap_s@@PAVCRopeSegment@@@Z@4PAUtypedescription_s@@A
	mov	DWORD PTR ?m_DataMap@CRopeSegment@@2Udatamap_s@@A, eax
...
; 60   : LINK_ENTITY_TO_CLASS( env_rope, CRope );
	...
	push	esi
	push	edi
	push	OFFSET ??_C@_08BECPGBEI@env_rope?$AA@
...
; Function compile flags: /Odtp /ZI
; File d:\!diffusion 2020\source code 2022\client-server\server\entities\env_rope.cpp
;	COMDAT ??$DataMapInit@VCRope@@@@YAPAUdatamap_s@@PAVCRope@@@Z
_TEXT	SEGMENT
__$EHRec$ = -12						; size = 12
___formal$ = 8						; size = 4
??$DataMapInit@VCRope@@@@YAPAUdatamap_s@@PAVCRope@@@Z PROC ; DataMapInit<CRope>, COMDAT
...
; 43   : BEGIN_DATADESC( CRope )
	...
	jne	SHORT $LN2@DataMapIni
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	push	OFFSET ??_C@_05KKBMKKNC@CRope?$AA@
	mov	ecx, OFFSET ?nameHolder@?1???$DataMapInit@VCRope@@@@YAPAUdatamap_s@@PAVCRope@@@Z@4VCDatadescGeneratedNameHolder@@A
	call	??0CDatadescGeneratedNameHolder@@QAE@PBD@Z ; CDatadescGeneratedNameHolder::CDatadescGeneratedNameHolder
...
; 44   : 	DEFINE_KEYFIELD( m_iSegments, FIELD_INTEGER, "segments" ),
...
; 53   : 	DEFINE_KEYFIELD( m_bDisallowPlayerAttachment, FIELD_BOOLEAN, "disable" ),
; 54   : 	DEFINE_KEYFIELD( m_iszBodyModel, FIELD_STRING, "bodymodel" ),
; 55   : 	DEFINE_KEYFIELD( m_iszEndingModel, FIELD_STRING, "endingmodel" ),
...
; 58   : END_DATADESC()
	...
	mov	eax, 24					; 00000018H
	shl	eax, 0
	add	eax, OFFSET ?dataDesc@?1???$DataMapInit@VCRope@@@@YAPAUdatamap_s@@PAVCRope@@@Z@4PAUtypedescription_s@@A
	mov	DWORD PTR ?m_DataMap@CRope@@2Udatamap_s@@A, eax
	jmp	SHORT $LN4@DataMapIni
$LN3@DataMapIni:
...
$T3 = -76						; size = 12
_vec$ = 8						; size = 4
?TruncateEpsilon@@YAXAAVVector@@@Z PROC			; TruncateEpsilon, COMDAT
...
; 610  : 			m_afPhysicsFlags |= PFLAG_ONROPE;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+2584]
	or	ecx, 64					; 00000040H
	mov	edx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [edx+2584], ecx
...
; 612  : 			m_afPhysicsFlags &= ~PFLAG_ONROPE;
...
; 605  : 	bool IsOnRope() const { return ( m_afPhysicsFlags & PFLAG_ONROPE ) != 0; }
...
_this$ = -4						; size = 4
_pRope$ = 8						; size = 4
?SetMasterRope@CRopeSegment@@QAEXPAVCRope@@@Z PROC	; CRopeSegment::SetMasterRope, COMDAT
; _this$ = ecx
...
; 978  : 
; 979  : 	pev->renderfx = pRope->pev->renderfx;
...
; 980  : 	pev->rendermode = pRope->pev->rendermode;
...
; 981  : 	pev->rendercolor = pRope->pev->rendercolor;
...
; 982  : 	pev->renderamt = pRope->pev->renderamt;
...
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File d:\!diffusion 2020\source code 2022\client-server\server\entities\cropesegment.h
...
?SetCanBeGrabbed@CRopeSegment@@QAEX_N@Z PROC		; CRopeSegment::SetCanBeGrabbed, COMDAT
; _this$ = ecx
...
; 1000 : 	m_bCanBeGrabbed = bCanBeGrabbed;

	mov	eax, DWORD PTR _this$[ebp]
	mov	cl, BYTE PTR _bCanBeGrabbed$[ebp]
	mov	BYTE PTR [eax+1925], cl
...
?SetCauseDamageOnTouch@CRopeSegment@@QAEX_N@Z PROC	; CRopeSegment::SetCauseDamageOnTouch, COMDAT
; _this$ = ecx
...
; 995  : 	m_bCauseDamage = bCauseDamage;

	mov	eax, DWORD PTR _this$[ebp]
	mov	cl, BYTE PTR _bCauseDamage$[ebp]
	mov	BYTE PTR [eax+1924], cl
...
_this$ = -4						; size = 4
_vecForce$ = 8						; size = 4
?ApplyExternalForce@CRopeSegment@@QAEXABVVector@@@Z PROC ; CRopeSegment::ApplyExternalForce, COMDAT
; _this$ = ecx
...
; 989  : 	m_Data.mApplyExternalForce = true;

	mov	eax, DWORD PTR _this$[ebp]
	mov	BYTE PTR [eax+1904], 1

; 990  : 	m_Data.mExternalForce += vecForce;

	mov	eax, DWORD PTR _vecForce$[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
?CreateSegment@CRopeSegment@@SAPAV1@HM@Z PROC		; CRopeSegment::CreateSegment, COMDAT
...
; 962  : 	CRopeSegment* pSegment = GetClassPtr((CRopeSegment*)NULL);
...
; 963  : 
; 964  : 	pSegment->SetClassname("rope_segment");

	push	OFFSET ??_C@_0N@JOACLEGN@rope_segment?$AA@
	mov	ecx, DWORD PTR _pSegment$[ebp]
	call	?SetClassname@CBaseEntity@@QAEXPBD@Z	; CBaseEntity::SetClassname

; 965  : 	pSegment->m_iszModelName = iszModelName;
...
; 967  : 
; 968  : 	pSegment->m_bCauseDamage = false;

	mov	eax, DWORD PTR _pSegment$[ebp]
	mov	BYTE PTR [eax+1924], 0

; 969  : 	pSegment->m_bCanBeGrabbed = true;

	mov	eax, DWORD PTR _pSegment$[ebp]
	mov	BYTE PTR [eax+1925], 1

; 970  : 	pSegment->m_Data.mMassReciprocal = flRecipMass;
...
$T1 = -108						; size = 12
$T2 = -96						; size = 12
_pSegment$3 = -20					; size = 4
_pRope$4 = -16						; size = 4
_vecVelocity$5 = -12					; size = 4
_pPlayer$6 = -8						; size = 4
_this$ = -4						; size = 4
_pOther$ = 8						; size = 4
?Touch@CRopeSegment@@UAEXPAVCBaseEntity@@@Z PROC	; CRopeSegment::Touch, COMDAT
; _this$ = ecx
...
; 898  : 	{
; 899  : 		CBasePlayer* pPlayer = (CBasePlayer*)pOther;

	mov	eax, DWORD PTR _pOther$[ebp]
	mov	DWORD PTR _pPlayer$6[ebp], eax

; 900  : 
; 901  : 		// Electrified wires deal damage. - Solokiller
; 902  : 		if (m_bCauseDamage)
...
; 903  : 		{
; 904  : 			if (gpGlobals->time >= pev->dmgtime)
...
; 905  : 			{
; 906  : 				if (pev->dmg < 0) pOther->TakeHealth(-pev->dmg, DMG_GENERIC);
...
; 907  : 				else pOther->TakeDamage(pev, pev, pev->dmg, DMG_SHOCK);
...
; 908  : 				pev->dmgtime = gpGlobals->time + 0.5f;
...
; 910  : 		}
; 911  : 
; 912  : 		if (GetMasterRope()->IsAcceptingAttachment() && !pPlayer->IsOnRope())
...
; 913  : 		{
; 914  : 			if (m_bCanBeGrabbed)

	mov	eax, DWORD PTR _this$[ebp]
	movzx	ecx, BYTE PTR [eax+1925]
	test	ecx, ecx
	je	$LN8@Touch

; 915  : 			{
; 916  : 				pOther->SetAbsOrigin(m_Data.mPosition);
...
; 920  : 				GetMasterRope()->AttachObjectToSegment(this);
...
; 921  : 
; 922  : 				const Vector& vecVelocity = pOther->GetAbsVelocity();

	mov	ecx, DWORD PTR _pOther$[ebp]
	call	?GetAbsVelocity@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsVelocity
	mov	DWORD PTR _vecVelocity$5[ebp], eax

; 923  : 
; 924  : 				if (vecVelocity.Length() > 0.5)

	mov	ecx, DWORD PTR _vecVelocity$5[ebp]
...
; 925  : 				{
; 926  : 					// Apply some external force to move the rope. - Solokiller
; 927  : 					m_Data.mApplyExternalForce = true;

	mov	eax, DWORD PTR _this$[ebp]
	mov	BYTE PTR [eax+1904], 1

; 928  : 					m_Data.mExternalForce = m_Data.mExternalForce + vecVelocity * 750;
...
; 929  : 				}
; 930  : 
; 931  : 				if (GetMasterRope()->IsSoundAllowed())
...
; 932  : 				{
; 933  : 					EMIT_SOUND(edict(), CHAN_BODY, "items/grab_rope.wav", 1.0, ATTN_NORM);
	...
	movss	DWORD PTR [esp], xmm0
	push	OFFSET ??_C@_0BE@OFPDCNNA@items?1grab_rope?4wav?$AA@
	push	4
	mov	ecx, DWORD PTR _this$[ebp]
...
; 937  : 			{
; 938  : 				// this segment cannot be grabbed, so grab the highest one if possible. - Solokiller
; 939  : 				CRope* pRope = GetMasterRope();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?GetMasterRope@CRopeSegment@@QAEPAVCRope@@XZ ; CRopeSegment::GetMasterRope
	mov	DWORD PTR _pRope$4[ebp], eax

; 940  : 
; 941  : 				CRopeSegment* pSegment;
; 942  : 
; 943  : 				if (pRope->GetNumSegments() <= 4)

	mov	ecx, DWORD PTR _pRope$4[ebp]
	call	?GetNumSegments@CRope@@QBEHXZ		; CRope::GetNumSegments
	cmp	eax, 4
	jg	SHORT $LN12@Touch

; 944  : 				{
; 945  : 					// fewer than 5 segments exist, so allow grabbing the last one. - Solokiller
; 946  : 					pSegment = pRope->GetSegments()[pRope->GetNumSegments() - 1];
	...
	mov	DWORD PTR _pSegment$3[ebp], eax

; 947  : 					pSegment->SetCanBeGrabbed(true);

	push	1
	mov	ecx, DWORD PTR _pSegment$3[ebp]
...
; 950  : 				{
; 951  : 					pSegment = pRope->GetSegments()[4];
	...
	mov	DWORD PTR _pSegment$3[ebp], edx
$LN13@Touch:

; 952  : 				}
; 953  : 
; 954  : 				pSegment->Touch(pOther);
...
_this$ = -4						; size = 4
?Spawn@CRopeSegment@@UAEXXZ PROC			; CRopeSegment::Spawn, COMDAT
; _this$ = ecx
...
; 867  : 
; 868  : 	SET_MODEL(edict(), STRING(m_iszModelName));
...
; 869  : 
; 870  : 	pev->movetype = MOVETYPE_NOCLIP;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+4]
	mov	DWORD PTR [ecx+264], 8

; 871  : 	pev->solid = SOLID_TRIGGER;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+4]
	mov	DWORD PTR [ecx+268], 1

; 872  : 	RelinkEntity(FALSE);
...
; 873  : 
; 874  : 	if (m_iszModelName != NULL_STRING)
...
; 875  : 	{
; 876  : 		if (UTIL_GetModelType(pev->modelindex) == mod_studio)
...
; 879  : 			GetAttachment(0, origin, angles);
...
; 880  : 			m_Data.restLength = (origin - GetAbsOrigin()).Length();
...
; 883  : 		{
; 884  : 			// debug, default
; 885  : 			m_Data.restLength = 15.0f;

	mov	eax, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@41700000
	movss	DWORD PTR [eax+1912], xmm0
$LN4@Spawn:
...
; 888  : 
; 889  : 	// use head_hull
; 890  : 	UTIL_SetSize(pev, Vector(-16, -16, -18), Vector(16, 16, 18));
...
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Precache@CRopeSegment@@UAEXXZ PROC			; CRopeSegment::Precache, COMDAT
; _this$ = ecx
...
; 858  : 	BaseClass::Precache();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?Precache@CBaseEntity@@UAEXXZ		; CBaseEntity::Precache

; 859  : 
; 860  : 	PRECACHE_MODEL(STRING(m_iszModelName));
...
; 861  : 	PRECACHE_SOUND("items/grab_rope.wav");
...
_this$ = -16						; size = 4
__$EHRec$ = -12						; size = 12
??0CRopeSegment@@QAE@XZ PROC				; CRopeSegment::CRopeSegment, COMDAT
; _this$ = ecx
...
; 853  : 	m_iszModelName = MAKE_STRING("models/rope16.mdl");

	push	OFFSET ??_C@_0BC@GNIPEJAC@models?1rope16?4mdl?$AA@
...
_TEXT	SEGMENT
_this$ = -4						; size = 4
?GetDataDescMap@CRopeSegment@@UAEPAUdatamap_s@@XZ PROC	; CRopeSegment::GetDataDescMap, COMDAT
; _this$ = ecx
...
_TEXT	SEGMENT
_pResult$ = -4						; size = 4
?GetBaseMap@CRopeSegment@@SAPAUdatamap_s@@XZ PROC	; CRopeSegment::GetBaseMap, COMDAT
...
_TEXT	SEGMENT
$T1 = -324						; size = 64
_local$2 = -192						; size = 64
_i$3 = -128						; size = 4
_ang$ = -124						; size = 12
_maxs$ = -112						; size = 12
_mins$ = -100						; size = 12
_pos$ = -88						; size = 12
_localSpace$ = -76					; size = 64
_phdr$ = -12						; size = 4
_this$ = -8						; size = 4
__$ArrayPad$ = -4					; size = 4
?SendUpdateBones@CRope@@QAEXXZ PROC			; CRope::SendUpdateBones, COMDAT
; _this$ = ecx
...
; 220  : 
; 221  : 	studiohdr_t *phdr = (studiohdr_t *)CBaseAnimating::GetModelPtr( pev->modelindex ); //diffusionanimfix
...
; 224  : 	matrix4x4 localSpace = EntityToWorldTransform().Invert();
	...
	lea	eax, DWORD PTR _localSpace$[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 232  : 	MESSAGE_BEGIN( MSG_PVS, gmsgSetupBones, pev->origin );
	...
	push	eax
	mov	ecx, DWORD PTR ?gmsgSetupBones@@3HA	; gmsgSetupBones
	push	ecx
	push	4
...
; 234  : 		WRITE_BYTE( phdr->numbones );                        //diffusionanimfix
...
; 238  : 			matrix4x4 local = m_pSegments[i]->EntityToWorldTransform();
	...
	mov	eax, DWORD PTR _i$3[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [ecx+eax*4+1864]
	call	?EntityToWorldTransform@CBaseEntity@@QAEAAVmatrix4x4@@XZ ; CBaseEntity::EntityToWorldTransform
	push	eax
	lea	ecx, DWORD PTR _local$2[ebp]
...
; 239  : 			local = localSpace.ConcatTransforms( local );
	...
	sub	esp, 64					; 00000040H
	mov	ecx, esp
	lea	eax, DWORD PTR _local$2[ebp]
	push	eax
	call	??0matrix4x4@@QAE@ABV0@@Z
	lea	ecx, DWORD PTR $T1[ebp]
	push	ecx
...
_pCurr$ = 8						; size = 4
_pNext$ = 12						; size = 4
?SetSegmentAngles@CRope@@QAEXPAVCRopeSegment@@0@Z PROC	; CRope::SetSegmentAngles, COMDAT
; _this$ = ecx
...
_pCurr$ = 8						; size = 4
_pNext$ = 12						; size = 4
?SetSegmentOrigin@CRope@@QAEXPAVCRopeSegment@@0@Z PROC	; CRope::SetSegmentOrigin, COMDAT
; _this$ = ecx
...
?GetAttachedObjectsPosition@CRope@@QBE?AVVector@@XZ PROC ; CRope::GetAttachedObjectsPosition, COMDAT
; _this$ = ecx
...
; 820  : 	if( m_iAttachedObjectsSegment < m_iSegments )
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [eax+2120]
	cmp	edx, DWORD PTR [ecx+1832]
...
; 821  : 		vecResult = m_pSegments[m_iAttachedObjectsSegment]->m_Data.mPosition;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+ecx*4+1864]
	add	eax, 1856				; 00000740H
	mov	ecx, DWORD PTR [eax]
...
?GetSegmentDirFromOrigin@CRope@@QBE?AVVector@@H@Z PROC	; CRope::GetSegmentDirFromOrigin, COMDAT
; _this$ = ecx
...
; 808  : 	const Vector vecResult = m_pSegments[iSegmentIndex + 1]->m_Data.mPosition - m_pSegments[iSegmentIndex]->m_Data.mPosition;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+eax*4+1864]
	add	edx, 1856				; 00000740H
	push	edx
	lea	eax, DWORD PTR _vecResult$[ebp]
	push	eax
	mov	ecx, DWORD PTR _iSegmentIndex$[ebp]
	mov	edx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [edx+ecx*4+1868]
	add	ecx, 1856				; 00000740H
	call	??GVector@@QBE?AV0@ABV0@@Z		; Vector::operator-
...
_this$ = -4						; size = 4
_pSegment$ = 8						; size = 4
?SetAttachedObjectsSegment@CRope@@QAEXPAVCRopeSegment@@@Z PROC ; CRope::SetAttachedObjectsSegment, COMDAT
; _this$ = ecx
...
_TEXT	SEGMENT
_pSegment$ = -32					; size = 4
_vecAngles$ = -28					; size = 12
_vecOrigin$ = -16					; size = 12
_this$ = -4						; size = 4
___$ReturnUdt$ = 8					; size = 4
_iSegment$ = 12						; size = 4
?GetSegmentAttachmentPoint@CRope@@QBE?AVVector@@H@Z PROC ; CRope::GetSegmentAttachmentPoint, COMDAT
; _this$ = ecx
...
; 783  : 	CRopeSegment* pSegment = m_pSegments[iSegment];
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+eax*4+1864]
	mov	DWORD PTR _pSegment$[ebp], edx
...
___$ReturnUdt$ = 8					; size = 4
_iSegment$ = 12						; size = 4
?GetSegmentOrigin@CRope@@QBE?AVVector@@H@Z PROC		; CRope::GetSegmentOrigin, COMDAT
; _this$ = ecx
...
_this$ = -4						; size = 4
_iSegment$ = 8						; size = 4
?IsValidSegmentIndex@CRope@@QBE_NH@Z PROC		; CRope::IsValidSegmentIndex, COMDAT
; _this$ = ecx
...
_this$ = -4						; size = 4
___$ReturnUdt$ = 8					; size = 4
?GetRopeOrigin@CRope@@QBE?AVVector@@XZ PROC		; CRope::GetRopeOrigin, COMDAT
; _this$ = ecx
...
; 755  : 	return m_pSegments[0]->m_Data.mPosition;
	...
	imul	ecx, eax, 0
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+ecx+1864]
	add	eax, 1856				; 00000740H
	push	eax
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0Vector@@QAE@ABV0@@Z			; Vector::Vector
...
_flLength$ = -8						; size = 4
_this$ = -4						; size = 4
?GetRopeLength@CRope@@QBEMXZ PROC			; CRope::GetRopeLength, COMDAT
; _this$ = ecx
...
?GetSegmentLength@CRope@@QBEMH@Z PROC			; CRope::GetSegmentLength, COMDAT
; _this$ = ecx
...
_flPitch$ = -36						; size = 4
_flRoll$ = -32						; size = 4
_vecResult$ = -28					; size = 12
_vecDist$ = -16						; size = 12
_this$ = -4						; size = 4
_vecTop$ = 8						; size = 4
_vecBottom$ = 12					; size = 4
_vecOut$ = 16						; size = 4
?GetAlignmentAngles@CRope@@QAEXABVVector@@0AAV2@@Z PROC	; CRope::GetAlignmentAngles, COMDAT
; _this$ = ecx
...
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File d:\!diffusion 2020\source code 2022\client-server\server\entities\crope.h
...
_data$1 = -8						; size = 4
_this$ = -4						; size = 4
?ShouldCreak@CRope@@QBE_NXZ PROC			; CRope::ShouldCreak, COMDAT
; _this$ = ecx
...
tv75 = -72						; size = 4
_this$ = -4						; size = 4
?IsAcceptingAttachment@CRope@@QBE_NXZ PROC		; CRope::IsAcceptingAttachment, COMDAT
; _this$ = ecx
...
_TEXT	SEGMENT
_this$ = -4						; size = 4
?DetachObject@CRope@@QAEXXZ PROC			; CRope::DetachObject, COMDAT
; _this$ = ecx
...
; 712  : 	m_flDetachTime = gpGlobals->time;
	...
	mov	edx, DWORD PTR [ecx]
	mov	DWORD PTR [eax+2136], edx

; 713  : 	m_bObjectAttached = false;

	mov	eax, DWORD PTR _this$[ebp]
	mov	BYTE PTR [eax+2132], 0
...
_this$ = -4						; size = 4
_pSegment$ = 8						; size = 4
?AttachObjectToSegment@CRope@@QAEXPAVCRopeSegment@@@Z PROC ; CRope::AttachObjectToSegment, COMDAT
; _this$ = ecx
...
; 705  : 	m_flAttachedObjectsOffset = 0;
	...
	mov	eax, DWORD PTR _this$[ebp]
	xorps	xmm0, xmm0
	movss	DWORD PTR [eax+2128], xmm0

; 706  : 	m_bObjectAttached = true;

	mov	eax, DWORD PTR _this$[ebp]
	mov	BYTE PTR [eax+2132], 1

; 707  : 	m_flDetachTime = 0;

	mov	eax, DWORD PTR _this$[ebp]
	xorps	xmm0, xmm0
	movss	DWORD PTR [eax+2136], xmm0
...
_vecForce$ = 8						; size = 4
_iSegment$ = 12						; size = 4
?ApplyForceToSegment@CRope@@QAEXABVVector@@H@Z PROC	; CRope::ApplyForceToSegment, COMDAT
; _this$ = ecx
...
; 692  : 		m_pSegments[iSegment]->ApplyExternalForce( vecForce );
	...
	mov	ecx, DWORD PTR _iSegment$[ebp]
	mov	edx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [edx+ecx*4+1864]
...
; 697  : 		m_pSegments[iSegment - 1]->ApplyExternalForce( vecForce );
	...
	mov	ecx, DWORD PTR _iSegment$[ebp]
	mov	edx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [edx+ecx*4+1860]
	call	?ApplyExternalForce@CRopeSegment@@QAEXABVVector@@@Z ; CRopeSegment::ApplyExternalForce
$LN1@ApplyForce:
...
_this$ = -4						; size = 4
_vecForce$ = 8						; size = 4
?ApplyForceFromPlayer@CRope@@QAEXABVVector@@@Z PROC	; CRope::ApplyForceFromPlayer, COMDAT
; _this$ = ecx
...
; 680  : 	if( m_iSegments < 26 )
	...
	mov	eax, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [eax+1832], 26		; 0000001aH
	jge	SHORT $LN3@ApplyForce

; 681  : 		flForce *= ( m_iSegments / 26.0 );

	mov	eax, DWORD PTR _this$[ebp]
	cvtsi2sd xmm0, DWORD PTR [eax+1832]
...
; 683  : 	const Vector vecScaledForce = vecForce * flForce;
	...
	movss	DWORD PTR [esp], xmm0
	lea	eax, DWORD PTR _vecScaledForce$[ebp]
	push	eax
...
_this$ = -4						; size = 4
___$ReturnUdt$ = 8					; size = 4
?GetAttachedObjectsVelocity@CRope@@QBE?AVVector@@XZ PROC ; CRope::GetAttachedObjectsVelocity, COMDAT
; _this$ = ecx
...
_flNewDist$3 = -16					; size = 4
_bOnRope$ = -10						; size = 1
_bDoIteration$ = -9					; size = 1
_flDistance$ = -8					; size = 4
_this$ = -4						; size = 4
_flDeltaTime$ = 8					; size = 4
?MoveDown@CRope@@QAE_NM@Z PROC				; CRope::MoveDown, COMDAT
; _this$ = ecx
...
; 623  : 	while( bDoIteration )
	...
	movzx	eax, BYTE PTR _bDoIteration$[ebp]
	test	eax, eax
	je	$LN3@MoveDown
...
_flOldDist$2 = -12					; size = 4
_flDistance$3 = -8					; size = 4
_this$ = -4						; size = 4
_flDeltaTime$ = 8					; size = 4
?MoveUp@CRope@@QAE_NM@Z PROC				; CRope::MoveUp, COMDAT
; _this$ = ecx
...
; 578  : 		float flDistance = flDeltaTime * 128.0f;
	...
	movss	xmm0, DWORD PTR _flDeltaTime$[ebp]
	mulss	xmm0, DWORD PTR __real@43000000
	movss	DWORD PTR _flDistance$3[ebp], xmm0
$LN2@MoveUp:
...
; 582  : 			float flOldDist = flDistance;
	...
	movss	DWORD PTR _flOldDist$2[ebp], xmm0
...
; 586  : 			if( flOldDist <= 0 )
	...
	xorps	xmm0, xmm0
	comiss	xmm0, DWORD PTR _flOldDist$2[ebp]
	jb	SHORT $LN5@MoveUp
...
; 592  : 			if( flOldDist > m_flAttachedObjectsOffset )
	...
	mov	eax, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR _flOldDist$2[ebp]
	comiss	xmm0, DWORD PTR [eax+2128]
...
; 606  : 				m_flAttachedObjectsOffset -= flOldDist;
	...
	mov	eax, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR [eax+2128]
	subss	xmm0, DWORD PTR _flOldDist$2[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	movss	DWORD PTR [ecx+2128], xmm0
$LN8@MoveUp:
...
$T5 = -300						; size = 12
$T6 = -288						; size = 12
_pSegment$7 = -212					; size = 4
_iSeg$8 = -208						; size = 4
_vecAngles$ = -204					; size = 12
_vecOrigin$9 = -192					; size = 12
_vecNormal$10 = -180					; size = 12
_vecOrigin$11 = -168					; size = 12
_pSegment$12 = -156					; size = 4
_iSeg$13 = -152						; size = 4
_vecOrigin$14 = -148					; size = 12
_data$15 = -136						; size = 4
_vecNormal$16 = -132					; size = 12
_vecOrigin$17 = -120					; size = 12
_vecEnd$18 = -108					; size = 12
_vecTraceDist$19 = -96					; size = 12
_flTraceDist$20 = -84					; size = 4
_vecDist$21 = -80					; size = 12
_pSegment$22 = -68					; size = 4
_iSeg$23 = -64						; size = 4
_tr$ = -60						; size = 56
_this$ = -4						; size = 4
?TraceModels@CRope@@QAEXXZ PROC				; CRope::TraceModels, COMDAT
; _this$ = ecx
...
; 470  : 		for( int iSeg = 1; iSeg < m_iNumSamples; iSeg++ )
	...
	mov	DWORD PTR _iSeg$23[ebp], 1
	jmp	SHORT $LN4@TraceModel
$LN2@TraceModel:
	mov	eax, DWORD PTR _iSeg$23[ebp]
	add	eax, 1
	mov	DWORD PTR _iSeg$23[ebp], eax
$LN4@TraceModel:
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _iSeg$23[ebp]
...
; 472  : 			CRopeSegment* pSegment = m_pSegments[iSeg];
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+eax*4+1864]
	mov	DWORD PTR _pSegment$22[ebp], edx
...
; 474  : 			Vector vecDist = pSegment->m_Data.mPosition - m_pSegments[iSeg]->GetAbsOrigin();
	...
	call	?GetAbsOrigin@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsOrigin
	push	eax
	lea	edx, DWORD PTR _vecDist$21[ebp]
	push	edx
...
; 476  : 			vecDist = vecDist.Normalize();
	...
	push	eax
	lea	ecx, DWORD PTR _vecDist$21[ebp]
	call	?Normalize@Vector@@QBE?AV1@XZ		; Vector::Normalize
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR _vecDist$21[ebp], ecx
	mov	edx, DWORD PTR [eax+4]
	mov	DWORD PTR _vecDist$21[ebp+4], edx
	mov	eax, DWORD PTR [eax+8]
	mov	DWORD PTR _vecDist$21[ebp+8], eax
...
$LN26@TraceModel:
	...
	movss	DWORD PTR _flTraceDist$20[ebp], xmm0

; 479  : 
; 480  : 			const Vector vecTraceDist = vecDist * flTraceDist;

	push	ecx
	movss	xmm0, DWORD PTR _flTraceDist$20[ebp]
	movss	DWORD PTR [esp], xmm0
	lea	eax, DWORD PTR _vecTraceDist$19[ebp]
	push	eax
	lea	ecx, DWORD PTR _vecDist$21[ebp]
	call	??DVector@@QBE?AV0@M@Z			; Vector::operator*
...
; 482  : 			const Vector vecEnd = pSegment->m_Data.mPosition + vecTraceDist;
	...
	lea	eax, DWORD PTR _vecTraceDist$19[ebp]
	push	eax
	lea	ecx, DWORD PTR _vecEnd$18[ebp]
	push	ecx
	mov	ecx, DWORD PTR _pSegment$22[ebp]
	add	ecx, 1856				; 00000740H
	call	??HVector@@QBE?AV0@ABV0@@Z		; Vector::operator+
...
; 493  : 				Vector vecOrigin = tr.vecEndPos - vecTraceDist;
	...
	lea	eax, DWORD PTR _vecTraceDist$19[ebp]
	push	eax
	lea	ecx, DWORD PTR _vecOrigin$17[ebp]
	push	ecx
...
; 495  : 				TruncateEpsilon( vecOrigin );
	...
	lea	eax, DWORD PTR _vecOrigin$17[ebp]
	push	eax
...
; 499  : 				Vector vecNormal = tr.vecPlaneNormal.Normalize() * 20000.0;
	...
	movss	xmm0, DWORD PTR __real@469c4000
	movss	DWORD PTR [esp], xmm0
	lea	eax, DWORD PTR _vecNormal$16[ebp]
	push	eax
...
; 501  : 				RopeSampleData& data = pSegment->m_Data;
	...
	add	eax, 1856				; 00000740H
	mov	DWORD PTR _data$15[ebp], eax

; 502  : 
; 503  : 				data.mApplyExternalForce = true;

	mov	eax, DWORD PTR _data$15[ebp]
...
; 504  : 				data.mExternalForce = vecNormal;
	...
	mov	ecx, DWORD PTR _vecNormal$16[ebp]
	mov	DWORD PTR [eax], ecx
	mov	edx, DWORD PTR _vecNormal$16[ebp+4]
	mov	DWORD PTR [eax+4], edx
	mov	ecx, DWORD PTR _vecNormal$16[ebp+8]
	mov	DWORD PTR [eax+8], ecx
...
; 509  : 				Vector vecOrigin = pSegment->m_Data.mPosition;
	...
	add	eax, 1856				; 00000740H
	push	eax
	lea	ecx, DWORD PTR _vecOrigin$14[ebp]
	call	??0Vector@@QAE@ABV0@@Z			; Vector::Vector

; 510  : 
; 511  : 				TruncateEpsilon( vecOrigin );

	lea	eax, DWORD PTR _vecOrigin$14[ebp]
	push	eax
	call	?TruncateEpsilon@@YAXAAVVector@@@Z	; TruncateEpsilon
	add	esp, 4
...
$LN7@TraceModel:
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _iSeg$13[ebp]
	cmp	ecx, DWORD PTR [eax+1836]
	jge	$LN6@TraceModel
...
; 521  : 			CRopeSegment* pSegment = m_pSegments[iSeg];
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+eax*4+1864]
	mov	DWORD PTR _pSegment$12[ebp], edx
...
; 523  : 			UTIL_TraceLine( pSegment->GetAbsOrigin(), pSegment->m_Data.mPosition, ignore_monsters, edict(), &tr );
	...
	push	eax
	push	1
	mov	ecx, DWORD PTR _pSegment$12[ebp]
	add	ecx, 1856				; 00000740H
	push	ecx
	mov	ecx, DWORD PTR _pSegment$12[ebp]
	call	?GetAbsOrigin@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsOrigin
...
; 527  : 				Vector vecOrigin = pSegment->m_Data.mPosition;
	...
	mov	eax, DWORD PTR _pSegment$12[ebp]
	add	eax, 1856				; 00000740H
	push	eax
...
; 535  : 				const Vector vecNormal = tr.vecPlaneNormal.Normalize();
	...
	lea	eax, DWORD PTR _vecNormal$10[ebp]
	push	eax
	lea	ecx, DWORD PTR _tr$[ebp+36]
	call	?Normalize@Vector@@QBE?AV1@XZ		; Vector::Normalize
...
; 537  : 				Vector vecOrigin = tr.vecEndPos + vecNormal * 10.0;
	...
	push	eax
	lea	ecx, DWORD PTR _vecNormal$10[ebp]
	call	??DVector@@QBE?AV0@M@Z			; Vector::operator*
	push	eax
...
; 550  : 	for( int iSeg = 1; iSeg < m_iNumSamples; iSeg++ )
	...
	mov	DWORD PTR _iSeg$8[ebp], 1
	jmp	SHORT $LN10@TraceModel
$LN8@TraceModel:
	mov	eax, DWORD PTR _iSeg$8[ebp]
	add	eax, 1
	mov	DWORD PTR _iSeg$8[ebp], eax
$LN10@TraceModel:
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _iSeg$8[ebp]
	cmp	ecx, DWORD PTR [eax+1836]
...
; 552  : 		SetSegmentAngles( m_pSegments[iSeg - 1], m_pSegments[iSeg] );
	...
	mov	eax, DWORD PTR _iSeg$8[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+eax*4+1860]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?SetSegmentAngles@CRope@@QAEXPAVCRopeSegment@@0@Z ; CRope::SetSegmentAngles
...
; 557  : 		CRopeSegment *pSegment = m_pSegments[m_iNumSamples - 1];
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+ecx*4+1860]
	mov	DWORD PTR _pSegment$7[ebp], eax
...
; 559  : 		UTIL_TraceLine( m_vecLastEndPos, pSegment->m_Data.mPosition, ignore_monsters, edict(), &tr );
	...
	push	eax
	push	1
	mov	ecx, DWORD PTR _pSegment$7[ebp]
	add	ecx, 1856				; 00000740H
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
...
; 563  : 			m_vecLastEndPos = pSegment->m_Data.mPosition;
	...
	mov	eax, DWORD PTR _pSegment$7[ebp]
	add	eax, 1856				; 00000740H
	mov	ecx, DWORD PTR _this$[ebp]
...
; 569  : 			pSegment->m_Data.mExternalForce = tr.vecPlaneNormal.Normalize() * 40000.0;
	...
	mov	ecx, eax
	call	??DVector@@QBE?AV0@M@Z			; Vector::operator*
	mov	edx, DWORD PTR _pSegment$7[ebp]
	add	edx, 1892				; 00000764H
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR [edx], ecx
	mov	ecx, DWORD PTR [eax+4]
...
_pTemp2$ = -32						; size = 4
_pTemp1$ = -28						; size = 4
_flDeltas$ = -24					; size = 16
_this$ = -8						; size = 4
__$ArrayPad$ = -4					; size = 4
_flDeltaTime$ = 8					; size = 4
?RK4Integrate@CRope@@QAEXM@Z PROC			; CRope::RK4Integrate, COMDAT
; _this$ = ecx
...
; 379  : 		const RopeSampleData& data = m_pSegments[i]->m_Data;
	...
	mov	edx, DWORD PTR [ecx+eax*4+1864]
	add	edx, 1856				; 00000740H
	mov	DWORD PTR _data$28[ebp], edx
...
; 381  : 		pTemp2->mForce = data.mMassReciprocal * data.mForce * flDeltas[0];
	...
	imul	ecx, eax, 0
	push	ecx
	movss	xmm0, DWORD PTR _flDeltas$[ebp+ecx]
	movss	DWORD PTR [esp], xmm0
...
; 420  : 		const RopeSampleData& data = m_pSegments[i]->m_Data;
	...
	mov	edx, DWORD PTR [ecx+eax*4+1864]
	add	edx, 1856				; 00000740H
	mov	DWORD PTR _data$25[ebp], edx
...
; 422  : 		pTemp2->mForce = data.mMassReciprocal * pTemp1->mForce * flDeltas[3];
	...
	add	eax, 24					; 00000018H
	push	eax
	mov	ecx, DWORD PTR _data$25[ebp]
	push	ecx
	movss	xmm0, DWORD PTR [ecx+52]
	movss	DWORD PTR [esp], xmm0
...
; 433  : 		CRopeSegment *pSegment = m_pSegments[i];
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+eax*4+1864]
	mov	DWORD PTR _pSegment$24[ebp], edx
...
; 435  : 		const Vector vecVelChange = 1.0f / 6.0f * ( pTemp1->mForce + ( pTemp2->mForce + pTemp3->mForce ) * 2 + pTemp4->mForce );
	...
	movss	xmm0, DWORD PTR __real@3e2aaaab
	movss	DWORD PTR [esp], xmm0
	lea	eax, DWORD PTR _vecVelChange$22[ebp]
	push	eax
	call	??D@YA?AVVector@@MABV0@@Z		; operator*
	add	esp, 12					; 0000000cH
...
; 438  : 		pSegment->m_Data.mPosition += vecPosChange;
	...
	lea	eax, DWORD PTR _vecPosChange$23[ebp]
	push	eax
	mov	ecx, DWORD PTR _pSegment$24[ebp]
	add	ecx, 1856				; 00000740H
	call	??YVector@@QAEAAV0@ABV0@@Z		; Vector::operator+=
...
$T1 = -148						; size = 12
$T2 = -136						; size = 12
_vecForce$ = -60					; size = 12
_flSpringFactor$ = -48					; size = 8
_flNewRelativeDist$ = -40				; size = 8
_flForce$ = -32						; size = 8
_flDistance$ = -24					; size = 8
_vecDist$ = -16						; size = 12
_this$ = -4						; size = 4
_first$ = 8						; size = 4
_second$ = 12						; size = 4
?ComputeSpringForce@CRope@@QAEXAAURopeSampleData@@0@Z PROC ; CRope::ComputeSpringForce, COMDAT
; _this$ = ecx
...
_this$ = -4						; size = 4
_data$ = 8						; size = 4
?ComputeSampleForce@CRope@@QAEXAAURopeSampleData@@@Z PROC ; CRope::ComputeSampleForce, COMDAT
; _this$ = ecx
...
_this$ = -4						; size = 4
_ppSystem$ = 8						; size = 4
?ComputeForces@CRope@@QAEXPAPAVCRopeSegment@@@Z PROC	; CRope::ComputeForces, COMDAT
; _this$ = ecx
...
_this$ = -4						; size = 4
_pSystem$ = 8						; size = 4
?ComputeForces@CRope@@QAEXPAURopeSampleData@@@Z PROC	; CRope::ComputeForces, COMDAT
; _this$ = ecx
...
; 298  : 		ComputeSpringForce( pSystem[i+0], pSystem[i+1] );
	...
	add	eax, 1
	imul	ecx, eax, 60
	add	ecx, DWORD PTR _pSystem$[ebp]
	push	ecx
...
tv77 = -88						; size = 4
_idx$1 = -20						; size = 4
_pSegment$2 = -16					; size = 4
_delta$ = -12						; size = 4
_subSteps$ = -8						; size = 4
_this$ = -4						; size = 4
?Think@CRope@@UAEXXZ PROC				; CRope::Think, COMDAT
; _this$ = ecx
...
; 264  : 		CRopeSegment* pSegment = m_pSegments[0];
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+ecx+1864]
	mov	DWORD PTR _pSegment$2[ebp], eax
...
$LN4@Think:
	mov	eax, DWORD PTR _idx$1[ebp]
	cmp	eax, DWORD PTR _subSteps$[ebp]
	jge	SHORT $LN3@Think
...
; 279  : 	{
; 280  : 		EMIT_SOUND( edict(), CHAN_BODY, g_pszCreakSounds[RANDOM_LONG( 0, SIZEOFARRAY( g_pszCreakSounds ) - 1 )], VOL_NORM, ATTN_NORM );
	...
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+360
	add	esp, 8
	mov	eax, DWORD PTR ?g_pszCreakSounds@@3QBQBDB[eax*4]
	push	eax
	push	4
	mov	ecx, DWORD PTR _this$[ebp]
	call	?edict@CBaseEntity@@QAEPAUedict_s@@XZ	; CBaseEntity::edict
...
$T4 = -208						; size = 12
$T5 = -196						; size = 12
_pSegment$6 = -120					; size = 4
_iSeg$7 = -116						; size = 4
_iSeg$8 = -112						; size = 4
_pCurr$9 = -108						; size = 4
_pPrev$10 = -104					; size = 4
_vecGravity$ = -100					; size = 12
_angles$ = -88						; size = 12
_origin$ = -76						; size = 12
_p1$11 = -64						; size = 12
_p0$12 = -52						; size = 12
_i$13 = -40						; size = 4
_pbone$14 = -36						; size = 4
_pSample$15 = -32					; size = 4
_i$16 = -28						; size = 4
_vecOrigin$ = -24					; size = 12
_phdr$ = -12						; size = 4
_modelindex$ = -8					; size = 4
_this$ = -4						; size = 4
?Spawn@CRope@@UAEXXZ PROC				; CRope::Spawn, COMDAT
; _this$ = ecx
...
; 107  : 		m_iszEndingModel = m_iszBodyModel;
	...
	mov	DWORD PTR [eax+2144], edx
$LN14@Spawn:

; 108  : 	m_bMakeSound = true;

	mov	eax, DWORD PTR _this$[ebp]
	mov	BYTE PTR [eax+2149], 1
...
; 132  : 			pSample = CRopeSegment :: CreateSegment( GetEndingModel( ), 1.0f );
	...
	add	esp, 8
	mov	DWORD PTR _pSample$15[ebp], eax
...
; 136  : 		if( i < ROPE_IGNORE_SAMPLES ) pSample->SetCanBeGrabbed( false );
	...
	push	0
	mov	ecx, DWORD PTR _pSample$15[ebp]
	call	?SetCanBeGrabbed@CRopeSegment@@QAEX_N@Z	; CRopeSegment::SetCanBeGrabbed
$LN20@Spawn:
...
; 141  : 		m_pSegments[i] = pSample;
	...
	mov	eax, DWORD PTR _i$16[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _pSample$15[ebp]
	mov	DWORD PTR [ecx+eax*4+1864], edx
...
; 146  : 		mstudiobone_t *pbone = (mstudiobone_t *)((byte *)phdr + phdr->boneindex);          
	...
	mov	DWORD PTR _pbone$14[ebp], ecx
...
; 152  : 				Vector p0 = Vector( pbone[i].value );                       
	...
	imul	eax, DWORD PTR _i$13[ebp], 112
	mov	ecx, DWORD PTR _pbone$14[ebp]
	lea	edx, DWORD PTR [ecx+eax+64]
	push	edx
	lea	ecx, DWORD PTR _p0$12[ebp]
...
; 153  : 				Vector p1 = Vector( pbone[i+1].value );
	...
	add	eax, 1
	imul	ecx, eax, 112
	mov	edx, DWORD PTR _pbone$14[ebp]
	lea	eax, DWORD PTR [edx+ecx+64]
	push	eax
	lea	ecx, DWORD PTR _p1$11[ebp]
	call	??0Vector@@QAE@QAM@Z			; Vector::Vector

; 154  : 				m_pSegments[i]->m_Data.restLength = (p1 - p0).Length();

	lea	eax, DWORD PTR _p0$12[ebp]
	push	eax
	lea	ecx, DWORD PTR $T4[ebp]
	push	ecx
	lea	ecx, DWORD PTR _p1$11[ebp]
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+edx*4+1864]
	fstp	DWORD PTR [ecx+1912]
...
; 157  : 				m_pSegments[i]->m_Data.restLength = m_pSegments[i-1]->m_Data.restLength;
	...
	mov	eax, DWORD PTR _i$13[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [ecx+eax*4+1864]
...
; 175  : 			pPrev = m_pSegments[iSeg - 1];
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+eax*4+1860]
	mov	DWORD PTR _pPrev$10[ebp], edx
...
; 179  : 			origin = pPrev->GetAbsOrigin() + pPrev->m_Data.restLength * vecGravity;
	...
	lea	eax, DWORD PTR _vecGravity$[ebp]
	push	eax
	mov	ecx, DWORD PTR _pPrev$10[ebp]
	push	ecx
	movss	xmm0, DWORD PTR [ecx+1912]
	movss	DWORD PTR [esp], xmm0
	lea	edx, DWORD PTR $T2[ebp]
	push	edx
	call	??D@YA?AVVector@@MABV0@@Z		; operator*
...
; 183  : 			SetSegmentAngles( pPrev, pCurr );
	...
	mov	eax, DWORD PTR _pCurr$9[ebp]
	push	eax
	mov	ecx, DWORD PTR _pPrev$10[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
...
; 188  : 	for( int iSeg = 0; iSeg < m_iNumSamples; iSeg++ )
	...
	mov	DWORD PTR _iSeg$7[ebp], 0
	jmp	SHORT $LN13@Spawn
$LN11@Spawn:
	mov	eax, DWORD PTR _iSeg$7[ebp]
	add	eax, 1
	mov	DWORD PTR _iSeg$7[ebp], eax
$LN13@Spawn:
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _iSeg$7[ebp]
	cmp	ecx, DWORD PTR [eax+1836]
...
; 190  : 		CRopeSegment* pSegment = m_pSegments[iSeg];
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+eax*4+1864]
	mov	DWORD PTR _pSegment$6[ebp], edx

; 191  : 		pSegment->m_Data.mPosition = pSegment->GetAbsOrigin();

	mov	ecx, DWORD PTR _pSegment$6[ebp]
	call	?GetAbsOrigin@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsOrigin
	mov	ecx, DWORD PTR _pSegment$6[ebp]
	add	ecx, 1856				; 00000740H
	mov	edx, DWORD PTR [eax]
...
_i$1 = -8						; size = 4
_this$ = -4						; size = 4
?Precache@CRope@@UAEXXZ PROC				; CRope::Precache, COMDAT
; _this$ = ecx
...
$LN4@Precache:
	...
	mov	eax, DWORD PTR _i$1[ebp]
	mov	ecx, DWORD PTR ?g_pszCreakSounds@@3QBQBDB[eax*4]
	push	ecx
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+4
	add	esp, 4
...
_this$ = -4						; size = 4
_pkvd$ = 8						; size = 4
?KeyValue@CRope@@UAEXPAUKeyValueData_s@@@Z PROC		; CRope::KeyValue, COMDAT
; _this$ = ecx
...
; 70   : 	if( FStrEq( pkvd->szKeyName, "segments" ))
	...
	push	OFFSET ??_C@_08GPGJEGMF@segments?$AA@
...
; 74   : 		if( m_iSegments >= MAX_SEGMENTS )
	...
	mov	eax, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [eax+1832], 64		; 00000040H
	jl	SHORT $LN4@KeyValue

; 75   : 			m_iSegments = MAX_SEGMENTS - 1;

	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+1832], 63		; 0000003fH
$LN4@KeyValue:
...
; 78   : 	else if( FStrEq( pkvd->szKeyName, "bodymodel" ))
	...
	push	OFFSET ??_C@_09PLPEIHCE@bodymodel?$AA@
	mov	eax, DWORD PTR _pkvd$[ebp]
	mov	ecx, DWORD PTR [eax+4]
	push	ecx
	call	?FStrEq@@YAHPBD0@Z			; FStrEq
...
; 83   : 	else if( FStrEq( pkvd->szKeyName, "endingmodel" ))
	...
	push	OFFSET ??_C@_0M@JNNHNIN@endingmodel?$AA@
	mov	eax, DWORD PTR _pkvd$[ebp]
	mov	ecx, DWORD PTR [eax+4]
	push	ecx
	call	?FStrEq@@YAHPBD0@Z			; FStrEq
...
; 88   : 	else if( FStrEq( pkvd->szKeyName, "disable" ))
	...
	push	OFFSET ??_C@_07DBNODEFN@disable?$AA@
	mov	eax, DWORD PTR _pkvd$[ebp]
	mov	ecx, DWORD PTR [eax+4]
	push	ecx
	call	?FStrEq@@YAHPBD0@Z			; FStrEq
...
_this$ = -16						; size = 4
__$EHRec$ = -12						; size = 12
??0CRope@@QAE@XZ PROC					; CRope::CRope, COMDAT
; _this$ = ecx
...
_TEXT	SEGMENT
_this$ = -4						; size = 4
?GetDataDescMap@CRope@@UAEPAUdatamap_s@@XZ PROC		; CRope::GetDataDescMap, COMDAT
; _this$ = ecx
...
_TEXT	SEGMENT
_pResult$ = -4						; size = 4
?GetBaseMap@CRope@@SAPAUdatamap_s@@XZ PROC		; CRope::GetBaseMap, COMDAT
