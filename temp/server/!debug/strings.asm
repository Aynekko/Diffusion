; Listing generated by Microsoft (R) Optimizing Compiler Version 19.00.24247.2 
	...
	TITLE	D:\!DIFFUSION 2020\source code 2022\client-server\server\strings.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??_C@_0CA@NPPDMMBH@Empty?5string?5has?5bad?5index?5?$CFi?$CB?6?$AA@ ; `string'
PUBLIC	??_C@_0BC@KOOLNKJJ@?5?5?$CFd?5?$CI0x?$CFx?$CJ?5?3?5?$CFs?6?$AA@ ; `string'
PUBLIC	??_C@_0BC@FGKGJNFK@?6Size?3?5?5?$CFd?5items?6?$AA@ ; `string'
...
PUBLIC	?$TSS0@?1??Links@?$CUtlRBTree@PBDGP6A_NABQBD0@ZV?$CUtlMemory@U?$UtlRBTreeNode_t@PBDG@@G@@@@IBEABU?$UtlRBTreeLinks_t@G@@G@Z@4HA ; `CUtlRBTree<char const *,unsigned short,bool (__cdecl*)(char const * const &,char const * const &),CUtlMemory<UtlRBTreeNode_t<char const *,unsigned short>,unsigned short> >::Links'::`2'::$TSS0
...
_BSS	SEGMENT
?$TSS0@?1??Links@?$CUtlRBTree@PBDGP6A_NABQBD0@ZV?$CUtlMemory@U?$UtlRBTreeNode_t@PBDG@@G@@@@IBEABU?$UtlRBTreeLinks_t@G@@G@Z@4HA DD 01H DUP (?) ; `CUtlRBTree<char const *,unsigned short,bool (__cdecl*)(char const * const &,char const * const &),CUtlMemory<UtlRBTreeNode_t<char const *,unsigned short>,unsigned short> >::Links'::`2'::$TSS0
_BSS	ENDS
CRT$XCU	SEGMENT
...
??_C@_1JE@LJJIJLOD@?$AAd?$AA?3?$AA?2?$AA?$CB?$AAd?$AAi?$AAf?$AAf?$AAu?$AAs?$AAi?$AAo?$AAn?$AA?5?$AA2?$AA0?$AA2?$AA0?$AA?2?$AAs?$AAo?$AAu?$AAr?$AAc?$AAe?$AA?5?$AAc?$AAo?$AAd?$AAe?$AA?5?$AA2@ DB 'd'
	...
	DB	'h', 00H, 00H, 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BC@FGKGJNFK@?6Size?3?5?5?$CFd?5items?6?$AA@
CONST	SEGMENT
??_C@_0BC@FGKGJNFK@?6Size?3?5?5?$CFd?5items?6?$AA@ DB 0aH, 'Size:  %d ite'
	DB	'ms', 0aH, 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BC@KOOLNKJJ@?5?5?$CFd?5?$CI0x?$CFx?$CJ?5?3?5?$CFs?6?$AA@
CONST	SEGMENT
??_C@_0BC@KOOLNKJJ@?5?5?$CFd?5?$CI0x?$CFx?$CJ?5?3?5?$CFs?6?$AA@ DB '  %d '
	DB	'(0x%x) : %s', 0aH, 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0CA@NPPDMMBH@Empty?5string?5has?5bad?5index?5?$CFi?$CB?6?$AA@
CONST	SEGMENT
??_C@_0CA@NPPDMMBH@Empty?5string?5has?5bad?5index?5?$CFi?$CB?6?$AA@ DB 'E'
	DB	'mpty string has bad index %i!', 0aH, 00H	; `string'
CONST	ENDS
...
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File d:\!diffusion 2020\source code 2022\client-server\server\strings.cpp
;	COMDAT ?StrLess@@YA_NABQBD0@Z
_TEXT	SEGMENT
tv69 = -68						; size = 4
_pszLeft$ = 8						; size = 4
_pszRight$ = 12						; size = 4
?StrLess@@YA_NABQBD0@Z PROC				; StrLess, COMDAT
...
; 593  : 	static Links_t s_Sentinel = 
	...
	mov	eax, DWORD PTR ?$TSS0@?1??Links@?$CUtlRBTree@PBDGP6A_NABQBD0@ZV?$CUtlMemory@U?$UtlRBTreeNode_t@PBDG@@G@@@@IBEABU?$UtlRBTreeLinks_t@G@@G@Z@4HA ; `CUtlRBTree<char const *,unsigned short,bool (__cdecl*)(char const * const &,char const * const &),CUtlMemory<UtlRBTreeNode_t<char const *,unsigned short>,unsigned short> >::Links'::`2'::$TSS0
	cmp	eax, DWORD PTR __Init_thread_epoch[edx]
	jle	SHORT $LN2@Links
	push	OFFSET ?$TSS0@?1??Links@?$CUtlRBTree@PBDGP6A_NABQBD0@ZV?$CUtlMemory@U?$UtlRBTreeNode_t@PBDG@@G@@@@IBEABU?$UtlRBTreeLinks_t@G@@G@Z@4HA ; `CUtlRBTree<char const *,unsigned short,bool (__cdecl*)(char const * const &,char const * const &),CUtlMemory<UtlRBTreeNode_t<char const *,unsigned short>,unsigned short> >::Links'::`2'::$TSS0
	call	__Init_thread_header
	add	esp, 4
	cmp	DWORD PTR ?$TSS0@?1??Links@?$CUtlRBTree@PBDGP6A_NABQBD0@ZV?$CUtlMemory@U?$UtlRBTreeNode_t@PBDG@@G@@@@IBEABU?$UtlRBTreeLinks_t@G@@G@Z@4HA, -1 ; `CUtlRBTree<char const *,unsigned short,bool (__cdecl*)(char const * const &,char const * const &),CUtlMemory<UtlRBTreeNode_t<char const *,unsigned short>,unsigned short> >::Links'::`2'::$TSS0
	jne	SHORT $LN2@Links
...
; 596  : 	};
	...
	mov	eax, 1
	mov	WORD PTR ?s_Sentinel@?1??Links@?$CUtlRBTree@PBDGP6A_NABQBD0@ZV?$CUtlMemory@U?$UtlRBTreeNode_t@PBDG@@G@@@@IBEABU?$UtlRBTreeLinks_t@G@@G@Z@4U3@A+6, ax
...
_i$1 = -8						; size = 4
_this$ = -4						; size = 4
?DumpSorted@CStringPool@@QAEXXZ PROC			; CStringPool::DumpSorted, COMDAT
; _this$ = ecx
...
; 95   : 		Msg( "  %d (0x%x) : %s\n", i, m_Strings[i], m_Strings[i] );
	...
	push	ecx
	push	OFFSET ??_C@_0BC@KOOLNKJJ@?5?5?$CFd?5?$CI0x?$CFx?$CJ?5?3?5?$CFs?6?$AA@
...
; 98   : 	Msg( "\nSize:  %d items\n", m_Strings.Count() );
	...
	call	?Count@?$CUtlRBTree@PBDGP6A_NABQBD0@ZV?$CUtlMemory@U?$UtlRBTreeNode_t@PBDG@@G@@@@QBEIXZ ; CUtlRBTree<char const *,unsigned short,bool (__cdecl*)(char const * const &,char const * const &),CUtlMemory<UtlRBTreeNode_t<char const *,unsigned short>,unsigned short> >::Count
	push	eax
	push	OFFSET ??_C@_0BC@FGKGJNFK@?6Size?3?5?5?$CFd?5items?6?$AA@
	call	?Msg@@YAXPBDZZ				; Msg
	add	esp, 8
...
_i$1 = -8						; size = 4
_this$ = -4						; size = 4
?Dump@CStringPool@@QAEXXZ PROC				; CStringPool::Dump, COMDAT
; _this$ = ecx
...
_i$ = -8						; size = 2
_this$ = -4						; size = 4
?FreeAll@CStringPool@@QAEXXZ PROC			; CStringPool::FreeAll, COMDAT
; _this$ = ecx
...
_i$ = -8						; size = 2
_this$ = -4						; size = 4
?MakeEmptyString@CStringPool@@QAEXXZ PROC		; CStringPool::MakeEmptyString, COMDAT
; _this$ = ecx
...
; 65   : 	if( i != 0 ) ALERT( at_error, "Empty string has bad index %i!\n", i );
	...
	movzx	eax, WORD PTR _i$[ebp]
	push	eax
	push	OFFSET ??_C@_0CA@NPPDMMBH@Empty?5string?5has?5bad?5index?5?$CFi?$CB?6?$AA@
	push	4
...
_this$ = -4						; size = 4
_iString$ = 8						; size = 4
?FindString@CStringPool@@QAEPBDH@Z PROC			; CStringPool::FindString, COMDAT
; _this$ = ecx
...
_this$ = -4						; size = 4
_pszValue$ = 8						; size = 4
?AllocString@CStringPool@@QAEHPBD@Z PROC		; CStringPool::AllocString, COMDAT
; _this$ = ecx
...
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Count@CStringPool@@QBEIXZ PROC				; CStringPool::Count, COMDAT
; _this$ = ecx
...
_this$ = -16						; size = 4
__$EHRec$ = -12						; size = 12
??1CStringPool@@QAE@XZ PROC				; CStringPool::~CStringPool, COMDAT
; _this$ = ecx
...
_this$ = -16						; size = 4
__$EHRec$ = -12						; size = 12
??0CStringPool@@QAE@XZ PROC				; CStringPool::CStringPool, COMDAT
; _this$ = ecx
