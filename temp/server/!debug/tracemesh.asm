; Listing generated by Microsoft (R) Optimizing Compiler Version 19.00.24247.2 
	...
	TITLE	D:\!DIFFUSION 2020\source code 2022\client-server\server\physics\tracemesh.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File d:\!diffusion 2020\source code 2022\client-server\server\physics\tracemesh.cpp
...
_facet$2 = -8						; size = 4
_this$ = -4						; size = 4
?DoTrace@TraceMesh@@QAE_NXZ PROC			; TraceMesh::DoTrace, COMDAT
; _this$ = ecx
...
_this$ = -4						; size = 4
_node$ = 8						; size = 4
?ClipToLinks@TraceMesh@@QAEXPAUareanode_s@@@Z PROC	; TraceMesh::ClipToLinks, COMDAT
; _this$ = ecx
...
_this$ = -4						; size = 4
_facet$ = 8						; size = 4
?TestBoxInFacet@TraceMesh@@QAEXPAUmfacet_t@@@Z PROC	; TraceMesh::TestBoxInFacet, COMDAT
; _this$ = ecx
...
; 211  : 			switch( p->signbits )
	...
	jmp	DWORD PTR $LN29@TestBoxInF[edx*4]
$LN11@TestBoxInF:
...
_getout$ = -29						; size = 1
_distfrac$ = -28					; size = 4
_leavefrac$ = -24					; size = 4
_enterfrac$ = -20					; size = 4
_planes$ = -16						; size = 4
_clipplane$ = -12					; size = 4
_p$ = -8						; size = 4
_this$ = -4						; size = 4
_facet$ = 8						; size = 4
?ClipBoxToFacet@TraceMesh@@QAEXPAUmfacet_t@@@Z PROC	; TraceMesh::ClipBoxToFacet, COMDAT
; _this$ = ecx
...
; 156  : 				clipplane = p;
	...
	mov	eax, DWORD PTR _p$[ebp]
	mov	DWORD PTR _clipplane$[ebp], eax
$LN25@ClipBoxToF:
...
; 167  : 	if( !startout )
	...
	movzx	eax, BYTE PTR _startout$[ebp]
	test	eax, eax
...
; 171  : 		if( !getout ) trace->allsolid = true;
	...
	movzx	eax, BYTE PTR _getout$[ebp]
	test	eax, eax
...
; 181  : 			trace->plane.normal = clipplane->normal;
	...
	mov	edx, DWORD PTR _clipplane$[ebp]
...
_end$ = 20						; size = 4
_tr$ = 24						; size = 4
?SetupTrace@TraceMesh@@QAEXABVVector@@000PAUtrace_s@@@Z PROC ; TraceMesh::SetupTrace, COMDAT
; _this$ = ecx
...
; 313  : 	dest.x = src1.x + (src2.x - src1.x) * t;
...
; 314  : 	dest.y = src1.y + (src2.y - src1.y) * t;
...
; 315  : 	dest.z = src1.z + (src2.z - src1.z) * t;
