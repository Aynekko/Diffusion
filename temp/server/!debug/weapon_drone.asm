; Listing generated by Microsoft (R) Optimizing Compiler Version 19.00.24247.2 
	...
	TITLE	D:\!DIFFUSION 2020\source code 2022\client-server\server\weapons\weapon_drone.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?m_DataMap@CWpnDrone@@2Udatamap_s@@A		; CWpnDrone::m_DataMap
PUBLIC	??_C@_09CGEPMEPF@CWpnDrone?$AA@			; `string'
PUBLIC	??_C@_0BB@OEMHBIGB@ConfirmExplosion?$AA@	; `string'
PUBLIC	??_C@_0BB@EOJEFFFG@ConfirmationTime?$AA@	; `string'
PUBLIC	??_C@_0M@HFJGNNFE@GotNewDrone?$AA@		; `string'
PUBLIC	??_C@_0O@JKAPNFC@DroneDeployed?$AA@		; `string'
...
CONST	ENDS
;	COMDAT ??_C@_0O@JKAPNFC@DroneDeployed?$AA@
CONST	SEGMENT
??_C@_0O@JKAPNFC@DroneDeployed?$AA@ DB 'DroneDeployed', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0M@HFJGNNFE@GotNewDrone?$AA@
CONST	SEGMENT
??_C@_0M@HFJGNNFE@GotNewDrone?$AA@ DB 'GotNewDrone', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BB@EOJEFFFG@ConfirmationTime?$AA@
CONST	SEGMENT
??_C@_0BB@EOJEFFFG@ConfirmationTime?$AA@ DB 'ConfirmationTime', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BB@OEMHBIGB@ConfirmExplosion?$AA@
CONST	SEGMENT
??_C@_0BB@OEMHBIGB@ConfirmExplosion?$AA@ DB 'ConfirmExplosion', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_09CGEPMEPF@CWpnDrone?$AA@
CONST	SEGMENT
??_C@_09CGEPMEPF@CWpnDrone?$AA@ DB 'CWpnDrone', 00H	; `string'
CONST	ENDS
_DATA	SEGMENT
?m_DataMap@CWpnDrone@@2Udatamap_s@@A DD 00H		; CWpnDrone::m_DataMap
	DD	00H
	DD	FLAT:??_C@_09CGEPMEPF@CWpnDrone?$AA@
	DD	00H
?dataDesc@?1???$DataMapInit@VCWpnDrone@@@@YAPAUdatamap_s@@PAVCWpnDrone@@@Z@4PAUtypedescription_s@@A DD 012H ; `DataMapInit<CWpnDrone>'::`2'::dataDesc
	DD	00H
	DD	00H
	DW	00H
	DW	00H
	...
	DD	00H
	DD	0aH
	DD	FLAT:??_C@_0BB@OEMHBIGB@ConfirmExplosion?$AA@
	DD	0788H
	DW	01H
	DW	02H
	DD	00H
	DD	00H
	DD	0fH
	DD	FLAT:??_C@_0BB@EOJEFFFG@ConfirmationTime?$AA@
	DD	078cH
	DW	01H
	DW	02H
	DD	00H
	DD	00H
	DD	0cH
	DD	FLAT:??_C@_0M@HFJGNNFE@GotNewDrone?$AA@
	DD	0790H
	DW	01H
	DW	02H
	DD	00H
	DD	00H
	DD	0cH
	DD	FLAT:??_C@_0O@JKAPNFC@DroneDeployed?$AA@
	DD	0791H
	DW	01H
	DW	02H
	DD	00H
...
PUBLIC	?Spawn@CWpnDrone@@UAEXXZ			; CWpnDrone::Spawn
PUBLIC	?Precache@CWpnDrone@@UAEXXZ			; CWpnDrone::Precache
PUBLIC	?iItemSlot@CWpnDrone@@UAEHXZ			; CWpnDrone::iItemSlot
PUBLIC	?GetItemInfo@CWpnDrone@@UAEHPAUItemInfo@@@Z	; CWpnDrone::GetItemInfo
PUBLIC	?AddToPlayer@CWpnDrone@@UAEHPAVCBasePlayer@@@Z	; CWpnDrone::AddToPlayer
PUBLIC	?PrimaryAttack@CWpnDrone@@UAEXXZ		; CWpnDrone::PrimaryAttack
PUBLIC	?SecondaryAttack@CWpnDrone@@UAEXXZ		; CWpnDrone::SecondaryAttack
PUBLIC	?IsUseable@CWpnDrone@@UAEHXZ			; CWpnDrone::IsUseable
PUBLIC	?CanDeploy@CWpnDrone@@UAEHXZ			; CWpnDrone::CanDeploy
PUBLIC	?Deploy@CWpnDrone@@UAEHXZ			; CWpnDrone::Deploy
PUBLIC	?Holster@CWpnDrone@@UAEXXZ			; CWpnDrone::Holster
PUBLIC	?WeaponIdle@CWpnDrone@@UAEXXZ			; CWpnDrone::WeaponIdle
PUBLIC	?CheckForDrone@CWpnDrone@@QAEHXZ		; CWpnDrone::CheckForDrone
PUBLIC	?AddDuplicate@CWpnDrone@@UAEHPAVCBasePlayerItem@@@Z ; CWpnDrone::AddDuplicate
PUBLIC	?SpawnTest@CWpnDrone@@QAE_NXZ			; CWpnDrone::SpawnTest
PUBLIC	?GetBaseMap@CWpnDrone@@SAPAUdatamap_s@@XZ	; CWpnDrone::GetBaseMap
PUBLIC	?GetDataDescMap@CWpnDrone@@UAEPAUdatamap_s@@XZ	; CWpnDrone::GetDataDescMap
PUBLIC	??0CWpnDrone@@QAE@XZ				; CWpnDrone::CWpnDrone
PUBLIC	??0?$CEntityFactory@VCWpnDrone@@@@QAE@PBD@Z	; CEntityFactory<CWpnDrone>::CEntityFactory<CWpnDrone>
PUBLIC	?Create@?$CEntityFactory@VCWpnDrone@@@@UAEPAVCBaseEntity@@PBDPAUentvars_s@@@Z ; CEntityFactory<CWpnDrone>::Create
PUBLIC	?Destroy@?$CEntityFactory@VCWpnDrone@@@@UAEXPAVCBaseEntity@@@Z ; CEntityFactory<CWpnDrone>::Destroy
PUBLIC	?GetEntitySize@?$CEntityFactory@VCWpnDrone@@@@UAEIXZ ; CEntityFactory<CWpnDrone>::GetEntitySize
PUBLIC	??$DataMapAccess@VCBasePlayerWeapon@@@@YAXPAVCBasePlayerWeapon@@PAPAUdatamap_s@@@Z ; DataMapAccess<CBasePlayerWeapon>
PUBLIC	??$DataMapInit@VCWpnDrone@@@@YAPAUdatamap_s@@PAVCWpnDrone@@@Z ; DataMapInit<CWpnDrone>
PUBLIC	??$GetClassPtr@VCWpnDrone@@@@YAPAVCWpnDrone@@PAV0@PBD@Z ; GetClassPtr<CWpnDrone>
...
PUBLIC	??_7CWpnDrone@@6B@				; CWpnDrone::`vftable'
PUBLIC	??_7?$CEntityFactory@VCWpnDrone@@@@6B@		; CEntityFactory<CWpnDrone>::`vftable'
PUBLIC	??_C@_0N@FKDJBBAF@weapon_drone?$AA@		; `string'
PUBLIC	?g_DataMapHolder@CWpnDrone_DataDescInit@@3PAUdatamap_s@@A ; CWpnDrone_DataDescInit::g_DataMapHolder
PUBLIC	??_C@_0N@INNMLFB@_playerdrone?$AA@		; `string'
PUBLIC	??_C@_0BD@LDOCDEKH@models?1v_drone?4mdl?$AA@	; `string'
PUBLIC	??_C@_0BD@FMNPJBEH@models?1p_drone?4mdl?$AA@	; `string'
PUBLIC	??_C@_0M@BLHFOIPE@info_target?$AA@		; `string'
PUBLIC	??_C@_0BO@OLDJMCMA@models?1npc?1drone_security?4mdl?$AA@ ; `string'
PUBLIC	??_C@_0BD@CIEHHIMI@models?1w_drone?4mdl?$AA@	; `string'
PUBLIC	??_C@_0BJ@ENAKLCBD@models?1v_drone_radio?4mdl?$AA@ ; `string'
PUBLIC	??_C@_0BJ@EDHGAOJG@models?1p_drone_radio?4mdl?$AA@ ; `string'
PUBLIC	??_C@_0BN@BBLELELN@weapons?1gauss_overcharge?4wav?$AA@ ; `string'
PUBLIC	??_C@_0BH@PAFPLFI@weapons?1drone_call?4wav?$AA@	; `string'
PUBLIC	??_C@_0BJ@KNHJDPLJ@buttons_hl2?1button17?4wav?$AA@ ; `string'
PUBLIC	??_C@_05GHMMDOCC@drone?$AA@			; `string'
...
PUBLIC	??_R4CWpnDrone@@6B@				; CWpnDrone::`RTTI Complete Object Locator'
PUBLIC	??_R0?AVCWpnDrone@@@8				; CWpnDrone `RTTI Type Descriptor'
PUBLIC	??_R3CWpnDrone@@8				; CWpnDrone::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2CWpnDrone@@8				; CWpnDrone::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@CWpnDrone@@8			; CWpnDrone::`RTTI Base Class Descriptor at (0,-1,0,64)'
PUBLIC	??_R4?$CEntityFactory@VCWpnDrone@@@@6B@		; CEntityFactory<CWpnDrone>::`RTTI Complete Object Locator'
PUBLIC	??_R0?AV?$CEntityFactory@VCWpnDrone@@@@@8	; CEntityFactory<CWpnDrone> `RTTI Type Descriptor'
PUBLIC	??_R3?$CEntityFactory@VCWpnDrone@@@@8		; CEntityFactory<CWpnDrone>::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2?$CEntityFactory@VCWpnDrone@@@@8		; CEntityFactory<CWpnDrone>::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@?$CEntityFactory@VCWpnDrone@@@@8	; CEntityFactory<CWpnDrone>::`RTTI Base Class Descriptor at (0,-1,0,64)'
...
EXTRN	?ChangeSchedule@CBaseMonster@@QAEXPAUSchedule_t@@@Z:PROC ; CBaseMonster::ChangeSchedule
...
_BSS	SEGMENT
?weapon_drone@@3V?$CEntityFactory@VCWpnDrone@@@@A DD 01H DUP (?) ; weapon_drone
?g_DataMapHolder@CWpnDrone_DataDescInit@@3PAUdatamap_s@@A DD 01H DUP (?) ; CWpnDrone_DataDescInit::g_DataMapHolder
?nameHolder@?1???$DataMapInit@VCWpnDrone@@@@YAPAUdatamap_s@@PAVCWpnDrone@@@Z@4VCDatadescGeneratedNameHolder@@A DB 01cH DUP (?) ; `DataMapInit<CWpnDrone>'::`2'::nameHolder
?$TSS0@?1???$DataMapInit@VCWpnDrone@@@@YAPAUdatamap_s@@PAVCWpnDrone@@@Z@4HA DD 01H DUP (?) ; `DataMapInit<CWpnDrone>'::`2'::$TSS0
_BSS	ENDS
CRT$XCU	SEGMENT
?weapon_drone$initializer$@@3P6AXXZA DD FLAT:??__Eweapon_drone@@YAXXZ ; weapon_drone$initializer$
CRT$XCU	ENDS
...
CONST	ENDS
;	COMDAT ??_R1A@?0A@EA@?$CEntityFactory@VCWpnDrone@@@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@?$CEntityFactory@VCWpnDrone@@@@8 DD FLAT:??_R0?AV?$CEntityFactory@VCWpnDrone@@@@@8 ; CEntityFactory<CWpnDrone>::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	01H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3?$CEntityFactory@VCWpnDrone@@@@8
rdata$r	ENDS
;	COMDAT ??_R2?$CEntityFactory@VCWpnDrone@@@@8
rdata$r	SEGMENT
??_R2?$CEntityFactory@VCWpnDrone@@@@8 DD FLAT:??_R1A@?0A@EA@?$CEntityFactory@VCWpnDrone@@@@8 ; CEntityFactory<CWpnDrone>::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@IEntityFactory@@8
rdata$r	ENDS
;	COMDAT ??_R3?$CEntityFactory@VCWpnDrone@@@@8
rdata$r	SEGMENT
??_R3?$CEntityFactory@VCWpnDrone@@@@8 DD 00H		; CEntityFactory<CWpnDrone>::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	02H
	DD	FLAT:??_R2?$CEntityFactory@VCWpnDrone@@@@8
rdata$r	ENDS
;	COMDAT ??_R0?AV?$CEntityFactory@VCWpnDrone@@@@@8
data$r	SEGMENT
??_R0?AV?$CEntityFactory@VCWpnDrone@@@@@8 DD FLAT:??_7type_info@@6B@ ; CEntityFactory<CWpnDrone> `RTTI Type Descriptor'
	DD	00H
	DB	'.?AV?$CEntityFactory@VCWpnDrone@@@@', 00H
data$r	ENDS
;	COMDAT ??_R4?$CEntityFactory@VCWpnDrone@@@@6B@
rdata$r	SEGMENT
??_R4?$CEntityFactory@VCWpnDrone@@@@6B@ DD 00H		; CEntityFactory<CWpnDrone>::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AV?$CEntityFactory@VCWpnDrone@@@@@8
	DD	FLAT:??_R3?$CEntityFactory@VCWpnDrone@@@@8
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@CWpnDrone@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@CWpnDrone@@8 DD FLAT:??_R0?AVCWpnDrone@@@8 ; CWpnDrone::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	05H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3CWpnDrone@@8
rdata$r	ENDS
;	COMDAT ??_R2CWpnDrone@@8
rdata$r	SEGMENT
??_R2CWpnDrone@@8 DD FLAT:??_R1A@?0A@EA@CWpnDrone@@8	; CWpnDrone::`RTTI Base Class Array'
...
rdata$r	ENDS
;	COMDAT ??_R3CWpnDrone@@8
rdata$r	SEGMENT
??_R3CWpnDrone@@8 DD 00H				; CWpnDrone::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	06H
	DD	FLAT:??_R2CWpnDrone@@8
rdata$r	ENDS
;	COMDAT ??_R0?AVCWpnDrone@@@8
data$r	SEGMENT
??_R0?AVCWpnDrone@@@8 DD FLAT:??_7type_info@@6B@	; CWpnDrone `RTTI Type Descriptor'
	DD	00H
	DB	'.?AVCWpnDrone@@', 00H
data$r	ENDS
;	COMDAT ??_R4CWpnDrone@@6B@
rdata$r	SEGMENT
??_R4CWpnDrone@@6B@ DD 00H				; CWpnDrone::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AVCWpnDrone@@@8
	DD	FLAT:??_R3CWpnDrone@@8
rdata$r	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_05GHMMDOCC@drone?$AA@
CONST	SEGMENT
??_C@_05GHMMDOCC@drone?$AA@ DB 'drone', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0BJ@KNHJDPLJ@buttons_hl2?1button17?4wav?$AA@
CONST	SEGMENT
??_C@_0BJ@KNHJDPLJ@buttons_hl2?1button17?4wav?$AA@ DB 'buttons_hl2/button'
	DB	'17.wav', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BH@PAFPLFI@weapons?1drone_call?4wav?$AA@
CONST	SEGMENT
??_C@_0BH@PAFPLFI@weapons?1drone_call?4wav?$AA@ DB 'weapons/drone_call.wa'
	DB	'v', 00H					; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_0BJ@EDHGAOJG@models?1p_drone_radio?4mdl?$AA@
CONST	SEGMENT
??_C@_0BJ@EDHGAOJG@models?1p_drone_radio?4mdl?$AA@ DB 'models/p_drone_rad'
	DB	'io.mdl', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BJ@ENAKLCBD@models?1v_drone_radio?4mdl?$AA@
CONST	SEGMENT
??_C@_0BJ@ENAKLCBD@models?1v_drone_radio?4mdl?$AA@ DB 'models/v_drone_rad'
	DB	'io.mdl', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BD@CIEHHIMI@models?1w_drone?4mdl?$AA@
CONST	SEGMENT
??_C@_0BD@CIEHHIMI@models?1w_drone?4mdl?$AA@ DB 'models/w_drone.mdl', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BO@OLDJMCMA@models?1npc?1drone_security?4mdl?$AA@
CONST	SEGMENT
??_C@_0BO@OLDJMCMA@models?1npc?1drone_security?4mdl?$AA@ DB 'models/npc/d'
	DB	'rone_security.mdl', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0M@BLHFOIPE@info_target?$AA@
CONST	SEGMENT
??_C@_0M@BLHFOIPE@info_target?$AA@ DB 'info_target', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BD@FMNPJBEH@models?1p_drone?4mdl?$AA@
CONST	SEGMENT
??_C@_0BD@FMNPJBEH@models?1p_drone?4mdl?$AA@ DB 'models/p_drone.mdl', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BD@LDOCDEKH@models?1v_drone?4mdl?$AA@
CONST	SEGMENT
??_C@_0BD@LDOCDEKH@models?1v_drone?4mdl?$AA@ DB 'models/v_drone.mdl', 00H ; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_7?$CEntityFactory@VCWpnDrone@@@@6B@
CONST	SEGMENT
??_7?$CEntityFactory@VCWpnDrone@@@@6B@ DD FLAT:??_R4?$CEntityFactory@VCWpnDrone@@@@6B@ ; CEntityFactory<CWpnDrone>::`vftable'
	DD	FLAT:?Create@?$CEntityFactory@VCWpnDrone@@@@UAEPAVCBaseEntity@@PBDPAUentvars_s@@@Z
	DD	FLAT:?Destroy@?$CEntityFactory@VCWpnDrone@@@@UAEXPAVCBaseEntity@@@Z
	DD	FLAT:?GetEntitySize@?$CEntityFactory@VCWpnDrone@@@@UAEIXZ
CONST	ENDS
;	COMDAT ??_7CWpnDrone@@6B@
CONST	SEGMENT
??_7CWpnDrone@@6B@ DD FLAT:??_R4CWpnDrone@@6B@		; CWpnDrone::`vftable'
	DD	FLAT:?GetDataDescMap@CWpnDrone@@UAEPAUdatamap_s@@XZ
	DD	FLAT:?Spawn@CWpnDrone@@UAEXXZ
	DD	FLAT:?Precache@CWpnDrone@@UAEXXZ
	...
	DD	FLAT:?AddToPlayer@CWpnDrone@@UAEHPAVCBasePlayer@@@Z
	DD	FLAT:?AddDuplicate@CWpnDrone@@UAEHPAVCBasePlayerItem@@@Z
	DD	FLAT:?GetItemInfo@CWpnDrone@@UAEHPAUItemInfo@@@Z
	DD	FLAT:?CanDeploy@CWpnDrone@@UAEHXZ
	DD	FLAT:?Deploy@CWpnDrone@@UAEHXZ
	DD	FLAT:?CanHolster@CBasePlayerItem@@UAEHXZ
	DD	FLAT:?Holster@CWpnDrone@@UAEXXZ
	...
	DD	FLAT:?iItemSlot@CWpnDrone@@UAEHXZ
	...
	DD	FLAT:?IsUseable@CWpnDrone@@UAEHXZ
	DD	FLAT:?PrimaryAttack@CWpnDrone@@UAEXXZ
	DD	FLAT:?SecondaryAttack@CWpnDrone@@UAEXXZ
	DD	FLAT:?Reload@CBasePlayerWeapon@@UAEXXZ
	DD	FLAT:?WeaponIdle@CWpnDrone@@UAEXXZ
...
;	COMDAT xdata$x
xdata$x	SEGMENT
__unwindtable$??$GetClassPtr@VCWpnDrone@@@@YAPAVCWpnDrone@@PAV0@PBD@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$??$GetClassPtr@VCWpnDrone@@@@YAPAVCWpnDrone@@PAV0@PBD@Z$0
__ehfuncinfo$??$GetClassPtr@VCWpnDrone@@@@YAPAVCWpnDrone@@PAV0@PBD@Z DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$??$GetClassPtr@VCWpnDrone@@@@YAPAVCWpnDrone@@PAV0@PBD@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
...
;	COMDAT xdata$x
xdata$x	SEGMENT
__unwindtable$??$DataMapInit@VCWpnDrone@@@@YAPAUdatamap_s@@PAVCWpnDrone@@@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$??$DataMapInit@VCWpnDrone@@@@YAPAUdatamap_s@@PAVCWpnDrone@@@Z$0
__ehfuncinfo$??$DataMapInit@VCWpnDrone@@@@YAPAUdatamap_s@@PAVCWpnDrone@@@Z DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$??$DataMapInit@VCWpnDrone@@@@YAPAUdatamap_s@@PAVCWpnDrone@@@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
...
xdata$x	ENDS
CRT$XCU	SEGMENT
?g_DataMapHolder$initializer$@CWpnDrone_DataDescInit@@3P6AXXZA DD FLAT:??__Eg_DataMapHolder@CWpnDrone_DataDescInit@@YAXXZ ; CWpnDrone_DataDescInit::g_DataMapHolder$initializer$
CRT$XCU	ENDS
...
;	COMDAT ??$GetClassPtr@VCWpnDrone@@@@YAPAVCWpnDrone@@PAV0@PBD@Z
_TEXT	SEGMENT
tv85 = -92						; size = 4
$T2 = -88						; size = 4
$T3 = -84						; size = 4
...
??$GetClassPtr@VCWpnDrone@@@@YAPAVCWpnDrone@@PAV0@PBD@Z PROC ; GetClassPtr<CWpnDrone>, COMDAT
...
; 1146 : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$??$GetClassPtr@VCWpnDrone@@@@YAPAVCWpnDrone@@PAV0@PBD@Z
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$??$GetClassPtr@VCWpnDrone@@@@YAPAVCWpnDrone@@PAV0@PBD@Z$0:
	mov	eax, DWORD PTR _pev$[ebp]
	push	eax
	...
	add	esp, 8
	ret	0
__ehhandler$??$GetClassPtr@VCWpnDrone@@@@YAPAVCWpnDrone@@PAV0@PBD@Z:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-96]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$??$GetClassPtr@VCWpnDrone@@@@YAPAVCWpnDrone@@PAV0@PBD@Z
	jmp	___CxxFrameHandler3
text$x	ENDS
??$GetClassPtr@VCWpnDrone@@@@YAPAVCWpnDrone@@PAV0@PBD@Z ENDP ; GetClassPtr<CWpnDrone>
; Function compile flags: /Odtp /ZI
;	COMDAT ??__FnameHolder@?1???$DataMapInit@VCWpnDrone@@@@YAPAUdatamap_s@@PAVCWpnDrone@@@Z@YAXXZ
text$yd	SEGMENT
??__FnameHolder@?1???$DataMapInit@VCWpnDrone@@@@YAPAUdatamap_s@@PAVCWpnDrone@@@Z@YAXXZ PROC ; `DataMapInit<CWpnDrone>'::`2'::`dynamic atexit destructor for 'nameHolder'', COMDAT
	push	ebp
	mov	ebp, esp
	sub	esp, 64					; 00000040H
	push	ebx
	push	esi
	push	edi
	mov	ecx, OFFSET ?nameHolder@?1???$DataMapInit@VCWpnDrone@@@@YAPAUdatamap_s@@PAVCWpnDrone@@@Z@4VCDatadescGeneratedNameHolder@@A
	...
	pop	ebp
	ret	0
??__FnameHolder@?1???$DataMapInit@VCWpnDrone@@@@YAPAUdatamap_s@@PAVCWpnDrone@@@Z@YAXXZ ENDP ; `DataMapInit<CWpnDrone>'::`2'::`dynamic atexit destructor for 'nameHolder''
text$yd	ENDS
; Function compile flags: /Odtp /ZI
; File d:\!diffusion 2020\source code 2022\client-server\server\weapons\weapon_drone.cpp
;	COMDAT ??__Eg_DataMapHolder@CWpnDrone_DataDescInit@@YAXXZ
text$di	SEGMENT
??__Eg_DataMapHolder@CWpnDrone_DataDescInit@@YAXXZ PROC	; CWpnDrone_DataDescInit::`dynamic initializer for 'g_DataMapHolder'', COMDAT

; 82   : BEGIN_DATADESC( CWpnDrone )
	...
	push	edi
	push	0
	call	??$DataMapInit@VCWpnDrone@@@@YAPAUdatamap_s@@PAVCWpnDrone@@@Z ; DataMapInit<CWpnDrone>
	add	esp, 4
	mov	DWORD PTR ?g_DataMapHolder@CWpnDrone_DataDescInit@@3PAUdatamap_s@@A, eax ; CWpnDrone_DataDescInit::g_DataMapHolder
	pop	edi
	pop	esi
	pop	ebx
	mov	esp, ebp
	pop	ebp
	ret	0
??__Eg_DataMapHolder@CWpnDrone_DataDescInit@@YAXXZ ENDP	; CWpnDrone_DataDescInit::`dynamic initializer for 'g_DataMapHolder''
text$di	ENDS
; Function compile flags: /Odtp /ZI
; File d:\!diffusion 2020\source code 2022\client-server\server\weapons\weapon_drone.cpp
;	COMDAT ??$DataMapInit@VCWpnDrone@@@@YAPAUdatamap_s@@PAVCWpnDrone@@@Z
_TEXT	SEGMENT
__$EHRec$ = -12						; size = 12
___formal$ = 8						; size = 4
??$DataMapInit@VCWpnDrone@@@@YAPAUdatamap_s@@PAVCWpnDrone@@@Z PROC ; DataMapInit<CWpnDrone>, COMDAT
...
; 82   : BEGIN_DATADESC( CWpnDrone )
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$??$DataMapInit@VCWpnDrone@@@@YAPAUdatamap_s@@PAVCWpnDrone@@@Z
	mov	eax, DWORD PTR fs:0
	push	eax
	sub	esp, 64					; 00000040H
	push	ebx
	...
	mov	eax, DWORD PTR ?$TSS0@?1???$DataMapInit@VCWpnDrone@@@@YAPAUdatamap_s@@PAVCWpnDrone@@@Z@4HA
	cmp	eax, DWORD PTR __Init_thread_epoch[edx]
	jle	SHORT $LN2@DataMapIni
	push	OFFSET ?$TSS0@?1???$DataMapInit@VCWpnDrone@@@@YAPAUdatamap_s@@PAVCWpnDrone@@@Z@4HA
	call	__Init_thread_header
	add	esp, 4
	cmp	DWORD PTR ?$TSS0@?1???$DataMapInit@VCWpnDrone@@@@YAPAUdatamap_s@@PAVCWpnDrone@@@Z@4HA, -1
	jne	SHORT $LN2@DataMapIni
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	push	OFFSET ??_C@_09CGEPMEPF@CWpnDrone?$AA@
	mov	ecx, OFFSET ?nameHolder@?1???$DataMapInit@VCWpnDrone@@@@YAPAUdatamap_s@@PAVCWpnDrone@@@Z@4VCDatadescGeneratedNameHolder@@A
	call	??0CDatadescGeneratedNameHolder@@QAE@PBD@Z ; CDatadescGeneratedNameHolder::CDatadescGeneratedNameHolder
	push	OFFSET ??__FnameHolder@?1???$DataMapInit@VCWpnDrone@@@@YAPAUdatamap_s@@PAVCWpnDrone@@@Z@YAXXZ ; `DataMapInit<CWpnDrone>'::`2'::`dynamic atexit destructor for 'nameHolder''
	call	_atexit
	add	esp, 4
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	push	OFFSET ?$TSS0@?1???$DataMapInit@VCWpnDrone@@@@YAPAUdatamap_s@@PAVCWpnDrone@@@Z@4HA
...
; 83   : 	DEFINE_FIELD( ConfirmExplosion, FIELD_INTEGER ),
; 84   : 	DEFINE_FIELD( ConfirmationTime, FIELD_TIME ),
; 85   : 	DEFINE_FIELD( GotNewDrone, FIELD_BOOLEAN ),
; 86   : 	DEFINE_FIELD( DroneDeployed, FIELD_BOOLEAN ),
; 87   : 	DEFINE_FIELD( m_hTestModel, FIELD_EHANDLE ),
; 88   : END_DATADESC()

	call	?GetBaseMap@CWpnDrone@@SAPAUdatamap_s@@XZ ; CWpnDrone::GetBaseMap
	mov	DWORD PTR ?m_DataMap@CWpnDrone@@2Udatamap_s@@A+12, eax
	mov	eax, 1
	test	eax, eax
	je	SHORT $LN3@DataMapIni
	mov	DWORD PTR ?m_DataMap@CWpnDrone@@2Udatamap_s@@A+4, 5
	mov	eax, 24					; 00000018H
	shl	eax, 0
	add	eax, OFFSET ?dataDesc@?1???$DataMapInit@VCWpnDrone@@@@YAPAUdatamap_s@@PAVCWpnDrone@@@Z@4PAUtypedescription_s@@A
	mov	DWORD PTR ?m_DataMap@CWpnDrone@@2Udatamap_s@@A, eax
	jmp	SHORT $LN4@DataMapIni
$LN3@DataMapIni:
	mov	DWORD PTR ?m_DataMap@CWpnDrone@@2Udatamap_s@@A+4, 1
	mov	DWORD PTR ?m_DataMap@CWpnDrone@@2Udatamap_s@@A, OFFSET ?dataDesc@?1???$DataMapInit@VCWpnDrone@@@@YAPAUdatamap_s@@PAVCWpnDrone@@@Z@4PAUtypedescription_s@@A
$LN4@DataMapIni:
	mov	eax, OFFSET ?m_DataMap@CWpnDrone@@2Udatamap_s@@A ; CWpnDrone::m_DataMap
	mov	ecx, DWORD PTR __$EHRec$[ebp]
	mov	DWORD PTR fs:0, ecx
	pop	ecx
	pop	edi
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$??$DataMapInit@VCWpnDrone@@@@YAPAUdatamap_s@@PAVCWpnDrone@@@Z$0:
	push	OFFSET ?$TSS0@?1???$DataMapInit@VCWpnDrone@@@@YAPAUdatamap_s@@PAVCWpnDrone@@@Z@4HA
	call	__Init_thread_abort
	pop	ecx
	ret	0
__ehhandler$??$DataMapInit@VCWpnDrone@@@@YAPAUdatamap_s@@PAVCWpnDrone@@@Z:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-80]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$??$DataMapInit@VCWpnDrone@@@@YAPAUdatamap_s@@PAVCWpnDrone@@@Z
	jmp	___CxxFrameHandler3
text$x	ENDS
??$DataMapInit@VCWpnDrone@@@@YAPAUdatamap_s@@PAVCWpnDrone@@@Z ENDP ; DataMapInit<CWpnDrone>
; Function compile flags: /Odtp /ZI
...
; Function compile flags: /Odtp /ZI
; File d:\!diffusion 2020\source code 2022\client-server\server\weapons\weapon_drone.cpp
;	COMDAT ??__Eweapon_drone@@YAXXZ
text$di	SEGMENT
??__Eweapon_drone@@YAXXZ PROC				; `dynamic initializer for 'weapon_drone'', COMDAT

; 80   : LINK_ENTITY_TO_CLASS( weapon_drone, CWpnDrone );
	...
	mov	ecx, OFFSET ?weapon_drone@@3V?$CEntityFactory@VCWpnDrone@@@@A
	call	??0?$CEntityFactory@VCWpnDrone@@@@QAE@PBD@Z ; CEntityFactory<CWpnDrone>::CEntityFactory<CWpnDrone>
	pop	edi
	pop	esi
	pop	ebx
	mov	esp, ebp
	pop	ebp
	ret	0
??__Eweapon_drone@@YAXXZ ENDP				; `dynamic initializer for 'weapon_drone''
text$di	ENDS
; Function compile flags: /Odtp /ZI
; File d:\!diffusion 2020\source code 2022\client-server\server\util.h
;	COMDAT ?GetEntitySize@?$CEntityFactory@VCWpnDrone@@@@UAEIXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?GetEntitySize@?$CEntityFactory@VCWpnDrone@@@@UAEIXZ PROC ; CEntityFactory<CWpnDrone>::GetEntitySize, COMDAT
; _this$ = ecx
...
; 105  : 	}
	...
	pop	ebp
	ret	0
?GetEntitySize@?$CEntityFactory@VCWpnDrone@@@@UAEIXZ ENDP ; CEntityFactory<CWpnDrone>::GetEntitySize
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File d:\!diffusion 2020\source code 2022\client-server\server\util.h
;	COMDAT ?Destroy@?$CEntityFactory@VCWpnDrone@@@@UAEXPAVCBaseEntity@@@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_pEntity$ = 8						; size = 4
?Destroy@?$CEntityFactory@VCWpnDrone@@@@UAEXPAVCBaseEntity@@@Z PROC ; CEntityFactory<CWpnDrone>::Destroy, COMDAT
; _this$ = ecx
...
; 100  : 	}
	...
	pop	ebp
	ret	4
?Destroy@?$CEntityFactory@VCWpnDrone@@@@UAEXPAVCBaseEntity@@@Z ENDP ; CEntityFactory<CWpnDrone>::Destroy
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File d:\!diffusion 2020\source code 2022\client-server\server\util.h
;	COMDAT ?Create@?$CEntityFactory@VCWpnDrone@@@@UAEPAVCBaseEntity@@PBDPAUentvars_s@@@Z
_TEXT	SEGMENT
_pEnt$ = -8						; size = 4
_this$ = -4						; size = 4
_pClassName$ = 8					; size = 4
_pev$ = 12						; size = 4
?Create@?$CEntityFactory@VCWpnDrone@@@@UAEPAVCBaseEntity@@PBDPAUentvars_s@@@Z PROC ; CEntityFactory<CWpnDrone>::Create, COMDAT
; _this$ = ecx
...
; 93   : 		T* pEnt = GetClassPtr((T*)pev, pClassName);
	...
	mov	ecx, DWORD PTR _pev$[ebp]
	push	ecx
	call	??$GetClassPtr@VCWpnDrone@@@@YAPAVCWpnDrone@@PAV0@PBD@Z ; GetClassPtr<CWpnDrone>
	add	esp, 8
...
; 95   : 	}
	...
	pop	ebp
	ret	8
?Create@?$CEntityFactory@VCWpnDrone@@@@UAEPAVCBaseEntity@@PBDPAUentvars_s@@@Z ENDP ; CEntityFactory<CWpnDrone>::Create
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File d:\!diffusion 2020\source code 2022\client-server\server\util.h
;	COMDAT ??0?$CEntityFactory@VCWpnDrone@@@@QAE@PBD@Z
_TEXT	SEGMENT
tv76 = -72						; size = 4
_this$ = -4						; size = 4
_pClassName$ = 8					; size = 4
??0?$CEntityFactory@VCWpnDrone@@@@QAE@PBD@Z PROC	; CEntityFactory<CWpnDrone>::CEntityFactory<CWpnDrone>, COMDAT
; _this$ = ecx
...
; 87   : 	{
	...
	mov	DWORD PTR [eax], OFFSET ??_7?$CEntityFactory@VCWpnDrone@@@@6B@
...
; 89   : 	}
	...
	pop	ebp
	ret	4
??0?$CEntityFactory@VCWpnDrone@@@@QAE@PBD@Z ENDP	; CEntityFactory<CWpnDrone>::CEntityFactory<CWpnDrone>
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
;	COMDAT ??0CWpnDrone@@QAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0CWpnDrone@@QAE@XZ PROC				; CWpnDrone::CWpnDrone, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET ??_7CWpnDrone@@6B@
	mov	eax, DWORD PTR _this$[ebp]
	pop	edi
	pop	esi
	pop	ebx
	...
	pop	ebp
	ret	0
??0CWpnDrone@@QAE@XZ ENDP				; CWpnDrone::CWpnDrone
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File d:\!diffusion 2020\source code 2022\client-server\server\weapons\weapon_drone.cpp
;	COMDAT ?GetDataDescMap@CWpnDrone@@UAEPAUdatamap_s@@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?GetDataDescMap@CWpnDrone@@UAEPAUdatamap_s@@XZ PROC	; CWpnDrone::GetDataDescMap, COMDAT
; _this$ = ecx
...
; 82   : BEGIN_DATADESC( CWpnDrone )
	...
	pop	ebp
	ret	0
?GetDataDescMap@CWpnDrone@@UAEPAUdatamap_s@@XZ ENDP	; CWpnDrone::GetDataDescMap
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File d:\!diffusion 2020\source code 2022\client-server\server\weapons\weapon_drone.cpp
;	COMDAT ?GetBaseMap@CWpnDrone@@SAPAUdatamap_s@@XZ
_TEXT	SEGMENT
_pResult$ = -4						; size = 4
?GetBaseMap@CWpnDrone@@SAPAUdatamap_s@@XZ PROC		; CWpnDrone::GetBaseMap, COMDAT
...
; 82   : BEGIN_DATADESC( CWpnDrone )
	...
	pop	ebp
	ret	0
?GetBaseMap@CWpnDrone@@SAPAUdatamap_s@@XZ ENDP		; CWpnDrone::GetBaseMap
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File d:\!diffusion 2020\source code 2022\client-server\server\weapons\weapon_drone.cpp
;	COMDAT ?SpawnTest@CWpnDrone@@QAE_NXZ
_TEXT	SEGMENT
$T1 = -184						; size = 12
$T2 = -172						; size = 12
$T3 = -160						; size = 12
...
_tracer$ = -60						; size = 56
_this$ = -4						; size = 4
?SpawnTest@CWpnDrone@@QAE_NXZ PROC			; CWpnDrone::SpawnTest, COMDAT
; _this$ = ecx
...
; 458  : 	TraceResult tracer;

	lea	ecx, DWORD PTR _tracer$[ebp]
	call	??0gametrace_s@@QAE@XZ

; 459  : 	Vector anglesAim = m_pPlayer->pev->v_angle;
...
; 461  : 	UTIL_MakeVectors( anglesAim );
...
; 462  : 	//	Vector vecSrc = m_pPlayer->GetAbsOrigin();
; 463  : 	//	Vector vecEnd = vecSrc + gpGlobals->v_forward * 50;
; 464  : 	Vector vecSrc = m_pPlayer->GetAbsOrigin() + gpGlobals->v_forward * 50 + gpGlobals->v_up * 20;
...
; 465  : 
; 466  : 	UTIL_TraceHull( vecSrc, vecSrc, dont_ignore_monsters, human_hull, m_pPlayer->edict(), &tracer );
...
; 467  : 	if( (tracer.flFraction < 1.0f) || tracer.fAllSolid )

	movss	xmm0, DWORD PTR __real@3f800000
	comiss	xmm0, DWORD PTR _tracer$[ebp+16]
	ja	SHORT $LN3@SpawnTest
	cmp	DWORD PTR _tracer$[ebp], 0
	je	SHORT $LN2@SpawnTest
$LN3@SpawnTest:
...
; 469  : 
; 470  : 	// don't spawn behind the glass!!!
; 471  : 	UTIL_TraceLine( m_pPlayer->GetAbsOrigin(), vecSrc, dont_ignore_monsters, dont_ignore_glass, edict(), &tracer );
...
; 472  : 	if( (tracer.flFraction < 1.0f) || tracer.fAllSolid )

	movss	xmm0, DWORD PTR __real@3f800000
	comiss	xmm0, DWORD PTR _tracer$[ebp+16]
	ja	SHORT $LN5@SpawnTest
	cmp	DWORD PTR _tracer$[ebp], 0
	je	SHORT $LN4@SpawnTest
$LN5@SpawnTest:
...
; 474  : 
; 475  : 	// last thing...
; 476  : 	if( UTIL_PointContents( vecSrc ) == CONTENTS_WATER )
...
; 480  : }
	...
	pop	ebp
	ret	0
?SpawnTest@CWpnDrone@@QAE_NXZ ENDP			; CWpnDrone::SpawnTest
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File d:\!diffusion 2020\source code 2022\client-server\server\weapons\weapon_drone.cpp
;	COMDAT ?AddDuplicate@CWpnDrone@@UAEHPAVCBasePlayerItem@@@Z
_TEXT	SEGMENT
_pWpnDrone$ = -8					; size = 4
_this$ = -4						; size = 4
_pOriginal$ = 8						; size = 4
?AddDuplicate@CWpnDrone@@UAEHPAVCBasePlayerItem@@@Z PROC ; CWpnDrone::AddDuplicate, COMDAT
; _this$ = ecx
...
; 238  : 	CWpnDrone *pWpnDrone;
; 239  : 	pWpnDrone = (CWpnDrone *)pOriginal;

	mov	eax, DWORD PTR _pOriginal$[ebp]
	mov	DWORD PTR _pWpnDrone$[ebp], eax

; 240  : 
; 241  : 	if( pWpnDrone->DroneDeployed )

	mov	eax, DWORD PTR _pWpnDrone$[ebp]
	movzx	ecx, BYTE PTR [eax+1937]
	test	ecx, ecx
	je	SHORT $LN2@AddDuplica

; 242  : 	{
; 243  : 		// player has a drone deployed. Refuse to add more.
; 244  : 		return FALSE;
...
; 245  : 	}
; 246  : 
; 247  : 	return CBasePlayerWeapon::AddDuplicate( pOriginal );
...
; 248  : }
	...
	pop	ebp
	ret	4
?AddDuplicate@CWpnDrone@@UAEHPAVCBasePlayerItem@@@Z ENDP ; CWpnDrone::AddDuplicate
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File d:\!diffusion 2020\source code 2022\client-server\server\weapons\weapon_drone.cpp
;	COMDAT ?CheckForDrone@CWpnDrone@@QAEHXZ
_TEXT	SEGMENT
_pDrone$ = -8						; size = 4
_this$ = -4						; size = 4
?CheckForDrone@CWpnDrone@@QAEHXZ PROC			; CWpnDrone::CheckForDrone, COMDAT
; _this$ = ecx
...
; 101  : 	CBaseEntity *pDrone = NULL;

	mov	DWORD PTR _pDrone$[ebp], 0

; 102  : 
; 103  : 	if ((pDrone = UTIL_FindEntityByClassname( pDrone, "_playerdrone" )) != NULL)

	push	OFFSET ??_C@_0N@INNMLFB@_playerdrone?$AA@
	mov	eax, DWORD PTR _pDrone$[ebp]
	push	eax
	call	?UTIL_FindEntityByClassname@@YAPAVCBaseEntity@@PAV1@PBD@Z ; UTIL_FindEntityByClassname
	add	esp, 8
	mov	DWORD PTR _pDrone$[ebp], eax
	cmp	DWORD PTR _pDrone$[ebp], 0
	je	SHORT $LN2@CheckForDr

; 104  : 	{
; 105  : 		m_pPlayer->DroneDeployed = true;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+1856]
	mov	BYTE PTR [ecx+4525], 1

; 106  : 		return TRUE;

	mov	eax, 1
	jmp	SHORT $LN1@CheckForDr
...
; 109  : 	{
; 110  : 		m_pPlayer->DroneDeployed = false;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+1856]
	mov	BYTE PTR [ecx+4525], 0
...
; 113  : }
	...
	pop	ebp
	ret	0
?CheckForDrone@CWpnDrone@@QAEHXZ ENDP			; CWpnDrone::CheckForDrone
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File d:\!diffusion 2020\source code 2022\client-server\server\weapons\weapon_drone.cpp
;	COMDAT ?WeaponIdle@CWpnDrone@@UAEXXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?WeaponIdle@CWpnDrone@@UAEXXZ PROC			; CWpnDrone::WeaponIdle, COMDAT
; _this$ = ecx
...
; 484  : 	/*
; 485  : 	if( ConfirmExplosion >= 1 )
; 486  : 	{	
; 487  : 		if( gpGlobals->time < ConfirmationTime - 2 )
; 488  : 		{
; 489  : 			ConfirmExplosion = 2;
; 490  : 			UTIL_ShowMessage( "UTIL_GRENSAFE1", m_pPlayer );
; 491  : 		}
; 492  : 		else if( gpGlobals->time < ConfirmationTime - 1 )
; 493  : 			UTIL_ShowMessage( "UTIL_GRENSAFE2", m_pPlayer );
; 494  : 		else if( gpGlobals->time < ConfirmationTime )
; 495  : 			UTIL_ShowMessage( "UTIL_GRENSAFE3", m_pPlayer );
; 496  : 		else if( gpGlobals->time > ConfirmationTime )
; 497  : 		{
; 498  : 			UTIL_ShowMessage( "UTIL_DRONEEXPLNO", m_pPlayer );
; 499  : 			EMIT_SOUND_DYN(ENT(m_pPlayer->pev), CHAN_ITEM, "weapons/gauss_overcharge.wav", 1.0, ATTN_NORM, 0, 100);
; 500  : 			ConfirmExplosion = 0;
; 501  : 		}
; 502  : 	}*/
; 503  : 	
; 504  : 	if( m_flTimeWeaponIdle == -1 )
...
; 506  : 	
; 507  : 	// HACKHACK if our drone died and we have some in the backpack, switch to it
; 508  : 	if((m_pPlayer->m_rgAmmo[ PrimaryAmmoIndex() ] > 0) && (m_pPlayer->DroneDeployed == false) )
	...
	jle	SHORT $LN3@WeaponIdle
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+1856]
	movzx	edx, BYTE PTR [ecx+4525]
	test	edx, edx
	jne	SHORT $LN3@WeaponIdle

; 509  : 	{
; 510  : 		m_pPlayer->pev->viewmodel = MAKE_STRING("models/v_drone.mdl");

	push	OFFSET ??_C@_0BD@LDOCDEKH@models?1v_drone?4mdl?$AA@
...
; 511  : 		m_pPlayer->pev->weaponmodel = MAKE_STRING("models/p_drone.mdl");

	push	OFFSET ??_C@_0BD@FMNPJBEH@models?1p_drone?4mdl?$AA@
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+268
	add	esp, 4
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+1856]
...
; 512  : 		SendWeaponAnim( DRONE_DEPLOY );
...
; 515  : }
	...
	pop	ebp
	ret	0
?WeaponIdle@CWpnDrone@@UAEXXZ ENDP			; CWpnDrone::WeaponIdle
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File d:\!diffusion 2020\source code 2022\client-server\server\weapons\weapon_drone.cpp
;	COMDAT ?Holster@CWpnDrone@@UAEXXZ
_TEXT	SEGMENT
tv73 = -72						; size = 4
_this$ = -4						; size = 4
?Holster@CWpnDrone@@UAEXXZ PROC				; CWpnDrone::Holster, COMDAT
; _this$ = ecx
...
; 278  : 		m_hTestModel->pev->effects |= EF_NODRAW;
...
; 281  : }
	...
	pop	ebp
	ret	0
?Holster@CWpnDrone@@UAEXXZ ENDP				; CWpnDrone::Holster
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File d:\!diffusion 2020\source code 2022\client-server\server\weapons\weapon_drone.cpp
;	COMDAT ?Deploy@CWpnDrone@@UAEHXZ
_TEXT	SEGMENT
tv77 = -72						; size = 4
_this$ = -4						; size = 4
?Deploy@CWpnDrone@@UAEHXZ PROC				; CWpnDrone::Deploy, COMDAT
; _this$ = ecx
...
; 252  : 	m_flNextPrimaryAttack = m_flNextSecondaryAttack = gpGlobals->time + 1.5;
...
; 253  : 
; 254  : 	ConfirmExplosion = 0;

	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+1928], 0

; 255  : 
; 256  : 	if( m_pPlayer->m_rgAmmo[m_iPrimaryAmmoType] > 0 )
	...
	jle	SHORT $LN2@Deploy

; 257  : 		GotNewDrone = true;
...
; 258  : 
; 259  : 	// perform a check for an active drone to determine what we should deploy
; 260  : 	if( CheckForDrone() == TRUE )

	mov	ecx, DWORD PTR _this$[ebp]
	call	?CheckForDrone@CWpnDrone@@QAEHXZ	; CWpnDrone::CheckForDrone
	cmp	eax, 1
	jne	SHORT $LN3@Deploy

; 261  : 		return DefaultDeploy( "models/v_drone_radio.mdl", "models/p_drone_radio.mdl", DRONERADIO_DEPLOY, "default" );

	push	0
	push	0
	push	OFFSET ??_C@_07DLHCIBDH@default?$AA@
	push	2
	push	OFFSET ??_C@_0BJ@EDHGAOJG@models?1p_drone_radio?4mdl?$AA@
	push	OFFSET ??_C@_0BJ@ENAKLCBD@models?1v_drone_radio?4mdl?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	call	?DefaultDeploy@CBasePlayerWeapon@@QAEHPAD0H0HH@Z ; CBasePlayerWeapon::DefaultDeploy
	jmp	SHORT $LN6@Deploy
...
; 263  : 	{
; 264  : 		// do we have a drone at all? if not, just draw the radio 
; 265  : 		if ( m_pPlayer->m_rgAmmo[ PrimaryAmmoIndex() ] <= 0 )
...
; 266  : 			return DefaultDeploy( "models/v_drone_radio.mdl", "models/p_drone_radio.mdl", DRONERADIO_DEPLOY, "default" );
...
; 268  : 		{
; 269  : 			m_flTimeWeaponIdle = -1;

	mov	eax, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@bf800000
	movss	DWORD PTR [eax+1892], xmm0

; 270  : 			return DefaultDeploy( "models/v_drone.mdl", "models/p_drone.mdl", DRONE_DEPLOY, "default");
...
; 273  : }
	...
	pop	ebp
	ret	0
?Deploy@CWpnDrone@@UAEHXZ ENDP				; CWpnDrone::Deploy
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File d:\!diffusion 2020\source code 2022\client-server\server\weapons\weapon_drone.cpp
;	COMDAT ?CanDeploy@CWpnDrone@@UAEHXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?CanDeploy@CWpnDrone@@UAEHXZ PROC			; CWpnDrone::CanDeploy, COMDAT
; _this$ = ecx
...
; 58   : 		if( m_pPlayer->m_iHideHUD & (HIDEHUD_WPNS | HIDEHUD_ALL|HIDEHUD_WPNS_HOLDABLEITEM|HIDEHUD_WPNS_CUSTOM) )
...
; 61   : 	}
	...
	pop	ebp
	ret	0
?CanDeploy@CWpnDrone@@UAEHXZ ENDP			; CWpnDrone::CanDeploy
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File d:\!diffusion 2020\source code 2022\client-server\server\weapons\weapon_drone.cpp
;	COMDAT ?IsUseable@CWpnDrone@@UAEHXZ
_TEXT	SEGMENT
tv383 = -156						; size = 4
tv277 = -156						; size = 4
tv256 = -156						; size = 4
...
$T4 = -116						; size = 12
$T5 = -104						; size = 12
_SpawnPos$6 = -28					; size = 12
_anglesAim$7 = -16					; size = 12
_this$ = -4						; size = 4
?IsUseable@CWpnDrone@@UAEHXZ PROC			; CWpnDrone::IsUseable, COMDAT
; _this$ = ecx
...
; 117  : 	// HACKHACK if we are holding a radio stick right now and got a drone, switch to it
; 118  : 	if( (GotNewDrone == false) && (m_pPlayer->m_rgAmmo[ PrimaryAmmoIndex() ] > 0) )
...
; 119  : 	{
; 120  : 		m_pPlayer->pev->viewmodel = MAKE_STRING("models/v_drone.mdl");
...
; 121  : 		m_pPlayer->pev->weaponmodel = MAKE_STRING("models/p_drone.mdl");
...
; 122  : 		SendWeaponAnim( DRONE_DEPLOY );
...
; 125  : 
; 126  : 	// sync
; 127  : 	DroneDeployed = m_pPlayer->DroneDeployed;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+1856]
	mov	edx, DWORD PTR _this$[ebp]
	mov	al, BYTE PTR [ecx+4525]
	mov	BYTE PTR [edx+1937], al

; 128  : 
; 129  : 	// show test model
; 130  : 	if( m_pPlayer->CanShoot && !m_pPlayer->DroneDeployed && (m_pPlayer->m_rgAmmo[PrimaryAmmoIndex()] > 0) )
...
; 133  : 		{
; 134  : 			m_hTestModel = CBaseEntity::Create( "info_target", m_pPlayer->GetAbsOrigin(), g_vecZero, 0 );
...
; 136  : 			{
; 137  : 				SET_MODEL( m_hTestModel->edict(), "models/npc/drone_security.mdl" );

	push	OFFSET ??_C@_0BO@OLDJMCMA@models?1npc?1drone_security?4mdl?$AA@
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 1940				; 00000794H
	call	??CEHANDLE@@QAEPAVCBaseEntity@@XZ	; EHANDLE::operator->
	mov	ecx, eax
...
; 138  : 				m_hTestModel->pev->rendermode = kRenderTransColor;
...
; 139  : 				m_hTestModel->pev->renderamt = 175;
...
; 140  : 				m_hTestModel->pev->renderfx = kRenderFxFullbrightNoShadows;
...
; 141  : 				m_hTestModel->pev->skin = 1; // green eye
...
; 142  : 				m_hTestModel->pev->effects |= EF_NODRAW;
...
; 146  : 		{
; 147  : 			if( (m_hTestModel->pev->effects & EF_NODRAW) && (gpGlobals->time > m_flNextPrimaryAttack) )
	...
	je	SHORT $LN8@IsUseable
	mov	eax, DWORD PTR ?gpGlobals@@3PAUglobalvars_t@@A ; gpGlobals
	mov	ecx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR [eax]
	comiss	xmm0, DWORD PTR [ecx+1884]
	jbe	SHORT $LN8@IsUseable
...
; 149  : 
; 150  : 			Vector anglesAim = m_pPlayer->pev->v_angle;
	...
	add	edx, 116				; 00000074H
	push	edx
	lea	ecx, DWORD PTR _anglesAim$7[ebp]
	call	??0Vector@@QAE@ABV0@@Z			; Vector::Vector

; 151  : 			anglesAim.x *= 0.8;

	cvtss2sd xmm0, DWORD PTR _anglesAim$7[ebp]
	mulsd	xmm0, QWORD PTR __real@3fe999999999999a
	cvtsd2ss xmm0, xmm0
	movss	DWORD PTR _anglesAim$7[ebp], xmm0

; 152  : 			UTIL_MakeVectors( anglesAim );

	lea	eax, DWORD PTR _anglesAim$7[ebp]
	push	eax
	call	?UTIL_MakeVectors@@YAXABVVector@@@Z	; UTIL_MakeVectors
	add	esp, 4

; 153  : 			Vector SpawnPos = m_pPlayer->GetAbsOrigin() + gpGlobals->v_forward * 50 + gpGlobals->v_up * 20;
	...
	call	??DVector@@QBE?AV0@M@Z			; Vector::operator*
	push	eax
	lea	ecx, DWORD PTR _SpawnPos$6[ebp]
	push	ecx
	push	ecx
	movss	xmm0, DWORD PTR __real@42480000
	movss	DWORD PTR [esp], xmm0
...
; 154  : 			m_hTestModel->SetAbsOrigin( SpawnPos );

	lea	eax, DWORD PTR _SpawnPos$6[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 1940				; 00000794H
	call	??CEHANDLE@@QAEPAVCBaseEntity@@XZ	; EHANDLE::operator->
...
; 155  : 			m_hTestModel->RelinkEntity( FALSE );
...
; 156  : 
; 157  : 			if( !SpawnTest() || (m_pPlayer->pev->waterlevel == 3) )

	mov	ecx, DWORD PTR _this$[ebp]
	call	?SpawnTest@CWpnDrone@@QAE_NXZ		; CWpnDrone::SpawnTest
	movzx	eax, al
	test	eax, eax
	je	SHORT $LN11@IsUseable
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+1856]
	mov	edx, DWORD PTR [ecx+4]
	cmp	DWORD PTR [edx+448], 3
	jne	SHORT $LN9@IsUseable
$LN11@IsUseable:

; 158  : 				m_hTestModel->pev->rendercolor = Vector( 255, 50, 50 );
...
; 159  : 			else
	...
	jmp	SHORT $LN10@IsUseable
$LN9@IsUseable:

; 160  : 				m_hTestModel->pev->rendercolor = Vector( 50, 255, 50 );
...
; 163  : 	else
	...
	jmp	SHORT $LN12@IsUseable
$LN3@IsUseable:

; 164  : 	{
; 165  : 		if( m_hTestModel != NULL )

	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 1940				; 00000794H
	call	??BEHANDLE@@QAEHXZ			; EHANDLE::operator int
	test	eax, eax
	je	SHORT $LN12@IsUseable

; 166  : 			m_hTestModel->pev->effects |= EF_NODRAW;
...
; 170  : }
	...
	pop	ebp
	ret	0
?IsUseable@CWpnDrone@@UAEHXZ ENDP			; CWpnDrone::IsUseable
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File d:\!diffusion 2020\source code 2022\client-server\server\weapons\weapon_drone.cpp
;	COMDAT ?SecondaryAttack@CWpnDrone@@UAEXXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?SecondaryAttack@CWpnDrone@@UAEXXZ PROC			; CWpnDrone::SecondaryAttack, COMDAT
; _this$ = ecx
...
; 406  : 	// don't hold the button
; 407  : 	CLIENT_COMMAND(m_pPlayer->edict(), "-attack2\n");
...
; 408  : 	
; 409  : 	if( m_pPlayer->DroneDeployed == false )
...
; 410  : 		return;
	...
	jmp	SHORT $LN1@SecondaryA
$LN2@SecondaryA:

; 411  : 
; 412  : 	m_flNextSecondaryAttack = gpGlobals->time + 2;
...
; 413  : 
; 414  : 	if( !m_pPlayer->DroneControl )

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+1856]
	movzx	edx, BYTE PTR [ecx+4544]
	test	edx, edx
	jne	SHORT $LN3@SecondaryA

; 415  : 		m_pPlayer->DroneControl = true;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+1856]
	mov	BYTE PTR [ecx+4544], 1

; 416  : 	else

	jmp	SHORT $LN4@SecondaryA
$LN3@SecondaryA:

; 417  : 		m_pPlayer->DroneControl = false;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+1856]
	mov	BYTE PTR [ecx+4544], 0
$LN4@SecondaryA:
$LN1@SecondaryA:

; 418  : /*
; 419  : 	// if the drone is on the map, on the first click we enter "waiting mode"
; 420  : 	// player has 3 seconds to click again to detonate the drone
; 421  : 	// if he didn't click, or switched the weapon, "waiting mode" is reset
; 422  : 
; 423  : 	// ConfirmExplosion: 0 - not in waiting mode, 1 - in waiting mode
; 424  : 
; 425  : 	if( ConfirmExplosion == 0 )
; 426  : 	{
; 427  : 		ConfirmationTime = gpGlobals->time + 3;
; 428  : 		SendWeaponAnim( DRONERADIO_CALL );
; 429  : 		EMIT_SOUND_DYN(ENT(m_pPlayer->pev), CHAN_ITEM, "buttons_hl2/button17.wav", 1.0, ATTN_NORM, 0, 80);
; 430  : 		ConfirmExplosion = 1;
; 431  : 	}
; 432  : 
; 433  : 	if( (ConfirmExplosion == 2) && (gpGlobals->time < ConfirmationTime) )
; 434  : 	{
; 435  : 		CBaseEntity *pTarget = NULL;
; 436  : 		
; 437  : 		if ((pTarget = UTIL_FindEntityByClassname( pTarget, "_playerdrone" )) != NULL)
; 438  : 		{
; 439  : 			CBaseMonster *pDrone = pTarget->MyMonsterPointer();
; 440  : 			if( pDrone )
; 441  : 			{
; 442  : 				UTIL_ShowMessage( "UTIL_DRONEEXPLYES", m_pPlayer );
; 443  : 				// kill our guy :(
; 444  : 				pDrone->TakeDamage( VARS(eoNullEntity), VARS(eoNullEntity), pDrone->pev->health * 2, DMG_SHOCK );
; 445  : 				EMIT_SOUND_DYN(ENT(m_pPlayer->pev), CHAN_ITEM, "buttons_hl2/button17.wav", 1.0, ATTN_NORM, 0, 100);
; 446  : 				SendWeaponAnim( DRONERADIO_CALL );
; 447  : 				ConfirmExplosion = 0;
; 448  : 				ConfirmationTime = 0;
; 449  : 				m_flNextSecondaryAttack = gpGlobals->time + 1;
; 450  : 			}
; 451  : 		}
; 452  : 	}
; 453  : */	
; 454  : }
	...
	pop	ebp
	ret	0
?SecondaryAttack@CWpnDrone@@UAEXXZ ENDP			; CWpnDrone::SecondaryAttack
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File d:\!diffusion 2020\source code 2022\client-server\server\weapons\weapon_drone.cpp
;	COMDAT ?PrimaryAttack@CWpnDrone@@UAEXXZ
_TEXT	SEGMENT
tv449 = -152						; size = 4
$T1 = -148						; size = 12
$T2 = -136						; size = 12
$T3 = -124						; size = 12
_pDrone$4 = -48						; size = 4
_pTarget$5 = -44					; size = 4
_DroneAmmo$6 = -40					; size = 4
_DroneHealth$7 = -36					; size = 4
_pDrone$8 = -32						; size = 4
_SpawnPos$9 = -28					; size = 12
_anglesAim$10 = -16					; size = 12
_this$ = -4						; size = 4
?PrimaryAttack@CWpnDrone@@UAEXXZ PROC			; CWpnDrone::PrimaryAttack, COMDAT
; _this$ = ecx
...
; 285  : 	if( m_pPlayer->pev->waterlevel == 3 )
...
; 286  : 	{
; 287  : 		EMIT_SOUND_DYN( ENT( m_pPlayer->pev ), CHAN_ITEM, "weapons/gauss_overcharge.wav", 1.0, ATTN_NORM, 0, 100 );
...
; 288  : 		m_flNextPrimaryAttack = gpGlobals->time + 1;
...
; 290  : 	}
; 291  : 	
; 292  : 	// we don't have an active drone on the map
; 293  : 	if( !m_pPlayer->DroneDeployed )
...
; 294  : 	{
; 295  : 		if( m_pPlayer->m_rgAmmo[m_iPrimaryAmmoType] <= 0 )
...
; 296  : 		{
; 297  : 			// no drones in the backpack, just make a false call
; 298  : 			SendWeaponAnim( DRONERADIO_CALL );
...
; 299  : 			EMIT_SOUND_DYN(ENT(m_pPlayer->pev), CHAN_ITEM, "weapons/gauss_overcharge.wav", 1.0, ATTN_NORM, 0, 100);
...
; 300  : 			m_flNextPrimaryAttack = gpGlobals->time + 1;
...
; 302  : 		}
; 303  : 		
; 304  : 		// we have a drone in the backpack, try to spawn it
; 305  : 		if( !SpawnTest() ) // not enough space
...
; 306  : 		{
; 307  : 			UTIL_ShowMessage( "UTIL_CANTSPAWN", m_pPlayer );
...
; 308  : 			m_flNextPrimaryAttack = gpGlobals->time + 0.2;
...
; 310  : 		}
; 311  : 
; 312  : 		Vector anglesAim = m_pPlayer->pev->v_angle;
	...
	add	edx, 116				; 00000074H
	push	edx
	lea	ecx, DWORD PTR _anglesAim$10[ebp]
	call	??0Vector@@QAE@ABV0@@Z			; Vector::Vector

; 313  : 		anglesAim.x *= 0.8;

	cvtss2sd xmm0, DWORD PTR _anglesAim$10[ebp]
	mulsd	xmm0, QWORD PTR __real@3fe999999999999a
	cvtsd2ss xmm0, xmm0
	movss	DWORD PTR _anglesAim$10[ebp], xmm0

; 314  : 		UTIL_MakeVectors( anglesAim );

	lea	eax, DWORD PTR _anglesAim$10[ebp]
	push	eax
	call	?UTIL_MakeVectors@@YAXABVVector@@@Z	; UTIL_MakeVectors
	add	esp, 4

; 315  : 		Vector SpawnPos = m_pPlayer->GetAbsOrigin() + gpGlobals->v_forward * 50 + gpGlobals->v_up * 20;
	...
	call	??DVector@@QBE?AV0@M@Z			; Vector::operator*
	push	eax
	lea	ecx, DWORD PTR _SpawnPos$9[ebp]
	push	ecx
	push	ecx
	movss	xmm0, DWORD PTR __real@42480000
	movss	DWORD PTR [esp], xmm0
...
; 316  : 		CBaseMonster *pDrone = (CBaseMonster*)Create( "_playerdrone", SpawnPos, g_vecZero, m_pPlayer->edict() );
	...
	call	?Create@CBaseEntity@@SAPAV1@PADABVVector@@1PAUedict_s@@@Z ; CBaseEntity::Create
	add	esp, 16					; 00000010H
	mov	DWORD PTR _pDrone$8[ebp], eax

; 317  : 		if(pDrone)

	cmp	DWORD PTR _pDrone$8[ebp], 0
	je	$LN7@PrimaryAtt

; 318  : 		{
; 319  : 			pDrone->m_iClass = CLASS_PLAYER_ALLY;

	mov	eax, DWORD PTR _pDrone$8[ebp]
	mov	DWORD PTR [eax+2464], 11		; 0000000bH

; 320  : 		//	pDrone->pev->targetname = MAKE_STRING( "testdrone" );
; 321  : 
; 322  : 			// this is important, so the monsters could see the drone if the player is outside their PVS
; 323  : 			// see CBaseMonster :: RunAI for details
; 324  : 			pDrone->pev->effects |= EF_MERGE_VISIBILITY;
...
; 325  : 
; 326  : 			// player gets this value when he picks up his flying drone.
; 327  : 			// when drone dies, or player loses all weapons, it's reset to 0
; 328  : 			float DroneHealth = m_pPlayer->DroneHealth;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+1856]
	movss	xmm0, DWORD PTR [ecx+4528]
	movss	DWORD PTR _DroneHealth$7[ebp], xmm0

; 329  : 			int DroneAmmo = m_pPlayer->DroneAmmo;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+1856]
	mov	edx, DWORD PTR [ecx+4532]
	mov	DWORD PTR _DroneAmmo$6[ebp], edx

; 330  : 			if( DroneAmmo == 0 )

	cmp	DWORD PTR _DroneAmmo$6[ebp], 0
	jne	SHORT $LN8@PrimaryAtt

; 331  : 				DroneAmmo = 500;

	mov	DWORD PTR _DroneAmmo$6[ebp], 500	; 000001f4H
$LN8@PrimaryAtt:

; 332  : 
; 333  : 			if( DroneHealth == 0 )

	movss	xmm0, DWORD PTR _DroneHealth$7[ebp]
	ucomiss	xmm0, DWORD PTR __real@00000000
	lahf
	test	ah, 68					; 00000044H
	jp	SHORT $LN9@PrimaryAtt
...
; 335  : 			else if( DroneHealth < 30 )

	movss	xmm0, DWORD PTR __real@41f00000
	comiss	xmm0, DWORD PTR _DroneHealth$7[ebp]
	jbe	SHORT $LN11@PrimaryAtt

; 336  : 				DroneHealth = 30; // let it live for a bit
...
; 337  : 
; 338  : 			pDrone->pev->health = DroneHealth;
...
; 340  : 			pDrone->m_iCounter = DroneAmmo;

	mov	eax, DWORD PTR _pDrone$8[ebp]
	mov	ecx, DWORD PTR _DroneAmmo$6[ebp]
	mov	DWORD PTR [eax+32], ecx

; 341  : 
; 342  : 			m_pPlayer->m_rgAmmo[m_iPrimaryAmmoType]--;
...
; 343  : 			if( m_pPlayer->m_rgAmmo[m_iPrimaryAmmoType] <= 0 )
...
; 345  : 
; 346  : 			// drone spawned, switch to radio
; 347  : 			m_pPlayer->pev->viewmodel = MAKE_STRING("models/v_drone_radio.mdl");
...
; 348  : 			m_pPlayer->pev->weaponmodel = MAKE_STRING("models/p_drone_radio.mdl");
...
; 349  : 			SendWeaponAnim( DRONERADIO_DEPLOY );
...
; 350  : 			m_pPlayer->DroneDeployed = true;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+1856]
	mov	BYTE PTR [ecx+4525], 1

; 351  : 			m_flTimeWeaponIdle = gpGlobals->time;
...
; 352  : 			m_flNextSecondaryAttack = gpGlobals->time + 1;
...
; 353  : 		}
; 354  : 	}
; 355  : 	else // we have an active drone, try to call it to our location

	jmp	$LN18@PrimaryAtt
$LN3@PrimaryAtt:

; 356  : 	{
; 357  : 		if( !m_pPlayer->DroneControl )
...
; 358  : 		{
; 359  : 			CBaseEntity *pTarget = NULL;

	mov	DWORD PTR _pTarget$5[ebp], 0

; 360  : 
; 361  : 		//	if( (pTarget = UTIL_FindEntityByClassname( pTarget, "_playerdrone" )) != NULL )
; 362  : 			if( m_pPlayer->m_hDrone != NULL )

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+1856]
	add	ecx, 4536				; 000011b8H
	call	??BEHANDLE@@QAEHXZ			; EHANDLE::operator int
	test	eax, eax
	je	$LN14@PrimaryAtt

; 363  : 			{
; 364  : 			//	CBaseMonster *pDrone = pTarget->MyMonsterPointer();
; 365  : 				CBaseMonster *pDrone = m_pPlayer->m_hDrone->MyMonsterPointer();
	...
	call	eax
	mov	DWORD PTR _pDrone$4[ebp], eax

; 366  : 				if( pDrone )

	cmp	DWORD PTR _pDrone$4[ebp], 0
	je	$LN16@PrimaryAtt

; 367  : 				{
; 368  : 					// drone to the rescue !!!
; 369  : 					EMIT_SOUND_DYN( ENT( m_pPlayer->pev ), CHAN_ITEM, "weapons/drone_call.wav", 0.5, ATTN_NORM, 0, 100 );
	...
	movss	DWORD PTR [esp], xmm0
	push	OFFSET ??_C@_0BH@PAFPLFI@weapons?1drone_call?4wav?$AA@
	push	3
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+1856]
	mov	edx, DWORD PTR [ecx+4]
...
; 370  : 					SendWeaponAnim( DRONERADIO_CALL );
...
; 371  : 					pDrone->m_hTargetEnt = m_pPlayer; // <-- important, otherwise crash :)

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+1856]
	push	ecx
	mov	ecx, DWORD PTR _pDrone$4[ebp]
	add	ecx, 2008				; 000007d8H
	call	??4EHANDLE@@QAEPAVCBaseEntity@@PAV1@@Z	; EHANDLE::operator=

; 372  : 					pDrone->ChangeSchedule( pDrone->GetScheduleOfType( SCHED_CHASE_OWNER ) );

	push	44					; 0000002cH
	mov	eax, DWORD PTR _pDrone$4[ebp]
	mov	edx, DWORD PTR [eax]
	mov	ecx, DWORD PTR _pDrone$4[ebp]
...
; 376  : 			{
; 377  : 				//			ALERT(at_console, "Can't find the drone!\n");
; 378  : 							// no one responded to our call, drone absent, switch state and viewmodel
; 379  : 				m_pPlayer->DroneDeployed = false;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+1856]
	mov	BYTE PTR [ecx+4525], 0

; 380  : 				if( m_pPlayer->m_rgAmmo[m_iPrimaryAmmoType] > 0 )
	...
	mov	eax, DWORD PTR [edx+1896]
	cmp	DWORD PTR [ecx+eax*4+3628], 0
	jle	SHORT $LN17@PrimaryAtt

; 381  : 				{
; 382  : 					m_pPlayer->pev->viewmodel = MAKE_STRING( "models/v_drone.mdl" );
...
; 383  : 					m_pPlayer->pev->weaponmodel = MAKE_STRING( "models/p_drone.mdl" );
...
; 384  : 					SendWeaponAnim( DRONE_DEPLOY );
...
; 386  : 				else
	...
	jmp	SHORT $LN18@PrimaryAtt
$LN17@PrimaryAtt:

; 387  : 				{
; 388  : 					SendWeaponAnim( DRONERADIO_CALL );
...
; 389  : 					EMIT_SOUND_DYN( ENT( m_pPlayer->pev ), CHAN_ITEM, "weapons/gauss_overcharge.wav", 1.0, ATTN_NORM, 0, 100 );
...
; 390  : 					m_flNextPrimaryAttack = gpGlobals->time + 1;
...
; 395  : 	}
; 396  : 
; 397  : 	// don't hold the button if not shooting
; 398  : 	if( !m_pPlayer->DroneControl )

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+1856]
	movzx	edx, BYTE PTR [ecx+4544]
	test	edx, edx
	jne	SHORT $LN19@PrimaryAtt

; 399  : 		CLIENT_COMMAND( m_pPlayer->edict(), "-attack\n" );
...
; 400  : 
; 401  : 	m_flNextPrimaryAttack = gpGlobals->time + 1;
...
; 402  : }
	...
	pop	ebp
	ret	0
?PrimaryAttack@CWpnDrone@@UAEXXZ ENDP			; CWpnDrone::PrimaryAttack
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File d:\!diffusion 2020\source code 2022\client-server\server\weapons\weapon_drone.cpp
;	COMDAT ?AddToPlayer@CWpnDrone@@UAEHPAVCBasePlayer@@@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_pPlayer$ = 8						; size = 4
?AddToPlayer@CWpnDrone@@UAEHPAVCBasePlayer@@@Z PROC	; CWpnDrone::AddToPlayer, COMDAT
; _this$ = ecx
...
; 219  : 	if( pPlayer->DroneDeployed )

	mov	eax, DWORD PTR _pPlayer$[ebp]
	movzx	ecx, BYTE PTR [eax+4525]
	test	ecx, ecx
...
; 221  : 	
; 222  : 	if ( CBasePlayerWeapon::AddToPlayer( pPlayer ) )
...
; 223  : 	{
; 224  : 		MESSAGE_BEGIN( MSG_ONE, gmsgWeapPickup, NULL, pPlayer->pev );
...
; 231  : }
	...
	pop	ebp
	ret	4
?AddToPlayer@CWpnDrone@@UAEHPAVCBasePlayer@@@Z ENDP	; CWpnDrone::AddToPlayer
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File d:\!diffusion 2020\source code 2022\client-server\server\weapons\weapon_drone.cpp
;	COMDAT ?GetItemInfo@CWpnDrone@@UAEHPAUItemInfo@@@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_p$ = 8							; size = 4
?GetItemInfo@CWpnDrone@@UAEHPAUItemInfo@@@Z PROC	; CWpnDrone::GetItemInfo, COMDAT
; _this$ = ecx
...
; 201  : 	p->pszName = STRING(pev->classname);
...
; 202  : 	p->pszAmmo1 = "drone";

	mov	eax, DWORD PTR _p$[ebp]
	mov	DWORD PTR [eax+8], OFFSET ??_C@_05GHMMDOCC@drone?$AA@
...
; 210  : 	p->iId = m_iId = WEAPON_DRONE;

	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+1864], 17		; 00000011H
	mov	ecx, DWORD PTR _p$[ebp]
	mov	DWORD PTR [ecx+32], 17			; 00000011H

; 211  : 	p->iWeight = MP5_WEIGHT;

	mov	eax, DWORD PTR _p$[ebp]
	mov	DWORD PTR [eax+40], 15			; 0000000fH

; 212  : 	p->iFlags = ITEM_FLAG_SELECTONEMPTY;
...
; 215  : }
	...
	pop	ebp
	ret	4
?GetItemInfo@CWpnDrone@@UAEHPAUItemInfo@@@Z ENDP	; CWpnDrone::GetItemInfo
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File d:\!diffusion 2020\source code 2022\client-server\server\weapons\weapon_drone.cpp
;	COMDAT ?iItemSlot@CWpnDrone@@UAEHXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?iItemSlot@CWpnDrone@@UAEHXZ PROC			; CWpnDrone::iItemSlot, COMDAT
; _this$ = ecx
...
; 48   : 	int iItemSlot( void ) { return 4; }
	...
	pop	ebp
	ret	0
?iItemSlot@CWpnDrone@@UAEHXZ ENDP			; CWpnDrone::iItemSlot
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File d:\!diffusion 2020\source code 2022\client-server\server\weapons\weapon_drone.cpp
;	COMDAT ?Precache@CWpnDrone@@UAEXXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Precache@CWpnDrone@@UAEXXZ PROC			; CWpnDrone::Precache, COMDAT
; _this$ = ecx
...
; 187  : 	PRECACHE_MODEL("models/v_drone.mdl");

	push	OFFSET ??_C@_0BD@LDOCDEKH@models?1v_drone?4mdl?$AA@
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A
	add	esp, 4

; 188  : 	PRECACHE_MODEL("models/w_drone.mdl");

	push	OFFSET ??_C@_0BD@CIEHHIMI@models?1w_drone?4mdl?$AA@
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A
	add	esp, 4

; 189  : 	PRECACHE_MODEL("models/p_drone.mdl");

	push	OFFSET ??_C@_0BD@FMNPJBEH@models?1p_drone?4mdl?$AA@
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A
	add	esp, 4

; 190  : 	PRECACHE_MODEL("models/v_drone_radio.mdl");

	push	OFFSET ??_C@_0BJ@ENAKLCBD@models?1v_drone_radio?4mdl?$AA@
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A
	add	esp, 4

; 191  : 	PRECACHE_MODEL("models/p_drone_radio.mdl");

	push	OFFSET ??_C@_0BJ@EDHGAOJG@models?1p_drone_radio?4mdl?$AA@
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A
	add	esp, 4

; 192  : 	PRECACHE_SOUND("weapons/gauss_overcharge.wav");

	push	OFFSET ??_C@_0BN@BBLELELN@weapons?1gauss_overcharge?4wav?$AA@
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+4
	add	esp, 4

; 193  : 	PRECACHE_SOUND("weapons/drone_call.wav");

	push	OFFSET ??_C@_0BH@PAFPLFI@weapons?1drone_call?4wav?$AA@
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+4
	add	esp, 4

; 194  : 	PRECACHE_SOUND("buttons_hl2/button17.wav");

	push	OFFSET ??_C@_0BJ@KNHJDPLJ@buttons_hl2?1button17?4wav?$AA@
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+4
	add	esp, 4

; 195  : 
; 196  : 	UTIL_PrecacheOther("_playerdrone");
...
; 197  : }
	...
	pop	ebp
	ret	0
?Precache@CWpnDrone@@UAEXXZ ENDP			; CWpnDrone::Precache
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File d:\!diffusion 2020\source code 2022\client-server\server\weapons\weapon_drone.cpp
;	COMDAT ?Spawn@CWpnDrone@@UAEXXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Spawn@CWpnDrone@@UAEXXZ PROC				; CWpnDrone::Spawn, COMDAT
; _this$ = ecx
...
; 175  : 	SET_MODEL(ENT(pev), "models/w_drone.mdl");
...
; 176  : 	m_iId = WEAPON_DRONE;

	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+1864], 17		; 00000011H

; 177  : 
; 178  : 	m_iDefaultAmmo = 1;

	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+1920], 1

; 179  : 
; 180  : 	m_flTimeWeaponIdle = -1;
...
; 181  : 
; 182  : 	FallInit();// get ready to fall down.
...
; 183  : }
	...
	pop	ebp
	ret	0
?Spawn@CWpnDrone@@UAEXXZ ENDP				; CWpnDrone::Spawn
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
